...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetMainModeRuleFiltersAssociation
    {
        ...
        public IEnumerable<CIMFilterEntryBase> PartComponent(MSFTNetMainModeRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetMainModeRule> GroupComponent(CIMFilterEntryBase inPartComponent)
        {
            var scope = _scope;
