...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetSARuleMMAuthAssociation
    {
        ...
        public IEnumerable<MSFTNetIKEP1AuthSet> PartComponent(CIMSARule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMSARule> GroupComponent(MSFTNetIKEP1AuthSet inPartComponent)
        {
            var scope = _scope;
