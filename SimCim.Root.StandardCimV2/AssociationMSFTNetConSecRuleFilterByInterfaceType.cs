...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetConSecRuleFilterByInterfaceTypeAssociation
    {
        ...
        public IEnumerable<MSFTNetInterfaceTypeFilter> PartComponent(MSFTNetConSecRule inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetConSecRule> GroupComponent(MSFTNetInterfaceTypeFilter inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
