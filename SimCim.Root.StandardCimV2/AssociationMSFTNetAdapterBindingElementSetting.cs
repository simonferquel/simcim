...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterBindingElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterBindingSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterBindingSettingData inSettingData)
        {
            var scope = _scope;
