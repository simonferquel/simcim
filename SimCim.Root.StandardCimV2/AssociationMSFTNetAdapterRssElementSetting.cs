...
namespace SimCim.Root.StandardCimV2
{
    ...
    {
        private static AssociationResolver _resolver = new AssociationResolver("MSFT_NetAdapterRssElementSetting", "MSFT_NetAdapter", "MSFT_NetAdapterRssSettingData", "ManagedElement", "SettingData");
        private IInfrastructureObjectScope _scope;
        public MSFTNetAdapterRssElementSettingAssociation(IInfrastructureObjectScope scope)
        {
            _scope = scope;
        }
        ...
        public IObservable<MSFTNetAdapterRssSettingData> SettingDataAsync(MSFTNetAdapter inManagedElement, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IObservable<MSFTNetAdapter> ManagedElementAsync(MSFTNetAdapterRssSettingData inSettingData, CimOperationOptions options = null)
        {
            var scope = _scope;
