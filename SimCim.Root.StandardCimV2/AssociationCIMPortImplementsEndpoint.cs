...
namespace SimCim.Root.StandardCimV2
{
    public struct CIMPortImplementsEndpointAssociation
    {
        ...
        public IEnumerable<CIMProtocolEndpoint> Dependent(CIMLogicalPort inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMLogicalPort> Antecedent(CIMProtocolEndpoint inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
