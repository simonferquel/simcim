...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetLbfoTeamProviderAssociation
    {
        ...
        public IEnumerable<MSFTNetLbfoProvider> PartComponent(MSFTNetLbfoTeam inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetLbfoTeam> GroupComponent(MSFTNetLbfoProvider inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
