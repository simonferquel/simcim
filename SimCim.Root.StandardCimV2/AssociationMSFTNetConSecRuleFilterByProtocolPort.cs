...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetConSecRuleFilterByProtocolPortAssociation
    {
        ...
        public IEnumerable<MSFTNetProtocolPortFilter> PartComponent(MSFTNetConSecRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetConSecRule> GroupComponent(MSFTNetProtocolPortFilter inPartComponent)
        {
            var scope = _scope;
