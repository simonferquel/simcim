...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterVmqQueueElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterVmqQueueSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterVmqQueueSettingData inSettingData)
        {
            var scope = _scope;
