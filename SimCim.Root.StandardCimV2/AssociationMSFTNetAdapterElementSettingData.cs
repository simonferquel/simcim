...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterElementSettingDataAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterSettingData> SettingData(MSFTNetAdapter inManagedElement, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterSettingData inSettingData, CimOperationOptions options = null)
        {
            var scope = _scope;
