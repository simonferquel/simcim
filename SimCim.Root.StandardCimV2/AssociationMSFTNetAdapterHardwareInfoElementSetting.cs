...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterHardwareInfoElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterHardwareInfoSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterHardwareInfoSettingData inSettingData)
        {
            var scope = _scope;
