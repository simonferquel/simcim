...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterPacketDirectElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterPacketDirectSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterPacketDirectSettingData inSettingData)
        {
            var scope = _scope;
