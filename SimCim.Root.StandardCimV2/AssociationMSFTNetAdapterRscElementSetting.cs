...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterRscElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterRscSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterRscSettingData inSettingData)
        {
            var scope = _scope;
