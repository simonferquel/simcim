...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterIPsecOffloadV2ElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterIPsecOffloadV2SettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterIPsecOffloadV2SettingData inSettingData)
        {
            var scope = _scope;
