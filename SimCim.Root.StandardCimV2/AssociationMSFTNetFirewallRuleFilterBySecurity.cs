...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetFirewallRuleFilterBySecurityAssociation
    {
        ...
        public IEnumerable<MSFTNetNetworkLayerSecurityFilter> PartComponent(MSFTNetFirewallRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetFirewallRule> GroupComponent(MSFTNetNetworkLayerSecurityFilter inPartComponent)
        {
            var scope = _scope;
