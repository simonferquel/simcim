...
namespace SimCim.Root.StandardCimV2
{
    public struct CIMBindsToLANEndpointAssociation
    {
        ...
        public IEnumerable<CIMServiceAccessPoint> Dependent(CIMLANEndpoint inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMLANEndpoint> Antecedent(CIMServiceAccessPoint inDependent)
        {
            var scope = _scope;
