...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetFirewallRuleInProfileAssociation
    {
        ...
        public IEnumerable<MSFTNetFirewallRule> PartComponent(MSFTNetFirewallProfile inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetFirewallProfile> GroupComponent(MSFTNetFirewallRule inPartComponent)
        {
            var scope = _scope;
