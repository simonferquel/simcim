...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetFirewallRuleFilterByApplicationAssociation
    {
        ...
        public IEnumerable<MSFTNetApplicationFilter> PartComponent(MSFTNetFirewallRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetFirewallRule> GroupComponent(MSFTNetApplicationFilter inPartComponent)
        {
            var scope = _scope;
