...
{
    public class MSFTNetAdapterChecksumOffloadEncapsulationTypes : GenericInfrastructureObject
    {
        public MSFTNetAdapterChecksumOffloadEncapsulationTypes()
        {
        }

        public MSFTNetAdapterChecksumOffloadEncapsulationTypes(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
