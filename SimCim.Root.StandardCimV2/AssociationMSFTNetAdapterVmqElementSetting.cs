...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterVmqElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterVmqSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterVmqSettingData inSettingData)
        {
            var scope = _scope;
