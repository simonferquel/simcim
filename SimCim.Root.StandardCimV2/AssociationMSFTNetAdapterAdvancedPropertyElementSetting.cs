...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterAdvancedPropertyElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterAdvancedPropertySettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterAdvancedPropertySettingData inSettingData)
        {
            var scope = _scope;
