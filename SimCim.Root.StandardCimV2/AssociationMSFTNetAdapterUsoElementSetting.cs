...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterUsoElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterUsoSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterUsoSettingData inSettingData)
        {
            var scope = _scope;
