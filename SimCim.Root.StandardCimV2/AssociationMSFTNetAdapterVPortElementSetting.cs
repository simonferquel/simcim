...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterVPortElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterVPortSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterVPortSettingData inSettingData)
        {
            var scope = _scope;
