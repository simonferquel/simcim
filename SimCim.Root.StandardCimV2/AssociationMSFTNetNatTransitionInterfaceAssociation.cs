...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetNatTransitionInterfaceAssociationAssociation
    {
        ...
        public IEnumerable<MSFTNetNatTransitionConfiguration> SettingData(CIMNetworkPort inManagedElement, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMNetworkPort> ManagedElement(MSFTNetNatTransitionConfiguration inSettingData, CimOperationOptions options = null)
        {
            var scope = _scope;
