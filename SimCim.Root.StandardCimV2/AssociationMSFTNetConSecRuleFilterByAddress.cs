...
namespace SimCim.StandardCimV2
{
    public struct MSFTNetConSecRuleFilterByAddressAssociation
    {
        ...
        public IEnumerable<MSFTNetAddressFilter> PartComponent(MSFTNetConSecRule inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetConSecRule> GroupComponent(MSFTNetAddressFilter inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
