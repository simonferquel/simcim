...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetEventCaptureTargetCaptureProviderAssociation
    {
        ...
        public IEnumerable<MSFTNetEventPacketCaptureTarget> PartComponent(MSFTNetEventPacketCaptureProvider inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetEventPacketCaptureProvider> GroupComponent(MSFTNetEventPacketCaptureTarget inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
