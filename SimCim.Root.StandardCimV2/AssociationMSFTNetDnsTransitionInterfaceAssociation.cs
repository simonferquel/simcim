...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetDnsTransitionInterfaceAssociationAssociation
    {
        ...
        public IEnumerable<MSFTNetDnsTransitionConfiguration> SettingData(CIMNetworkPort inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMNetworkPort> ManagedElement(MSFTNetDnsTransitionConfiguration inSettingData)
        {
            var scope = _scope;
