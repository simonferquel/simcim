...
namespace SimCim.StandardCimV2
{
    public struct MSFTNetIPInterfaceAdapterAssociation
    {
        ...
        public IEnumerable<CIMNetworkPort> Dependent(MSFTNetIPInterface inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetIPInterface> Antecedent(CIMNetworkPort inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
