...
{
    public class MSFTNetIKECryptoSet : CIMIKEAction
    {
        public MSFTNetIKECryptoSet()
        {
        }

        public MSFTNetIKECryptoSet(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public IEnumerable<MSFTNetIKECryptoProposal> Proposals
        {
            get
            {
                IEnumerable<MSFTNetIKECryptoProposal> result;
