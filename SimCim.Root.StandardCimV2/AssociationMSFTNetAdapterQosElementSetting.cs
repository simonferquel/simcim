...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterQosElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterQosSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterQosSettingData inSettingData)
        {
            var scope = _scope;
