...
namespace SimCim.StandardCimV2
{
    public struct MSFTNetConSecRuleMMAuthSetAssociation
    {
        ...
        public IEnumerable<MSFTNetIKEP1AuthSet> PartComponent(MSFTNetConSecRule inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetConSecRule> GroupComponent(MSFTNetIKEP1AuthSet inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
