...
namespace SimCim.Root.StandardCimV2
{
    public struct CIMPolicyActionInPolicyRuleAssociation
    {
        ...
        public IEnumerable<CIMPolicyAction> PartComponent(CIMPolicyRule inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMPolicyRule> GroupComponent(CIMPolicyAction inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
