...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetFirewallRuleFiltersAssociation
    {
        ...
        public IEnumerable<CIMFilterEntryBase> PartComponent(MSFTNetFirewallRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetFirewallRule> GroupComponent(CIMFilterEntryBase inPartComponent)
        {
            var scope = _scope;
