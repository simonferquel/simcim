...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetConSecRuleFilterByInterfaceAssociation
    {
        ...
        public IEnumerable<MSFTNetInterfaceFilter> PartComponent(MSFTNetConSecRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetConSecRule> GroupComponent(MSFTNetInterfaceFilter inPartComponent)
        {
            var scope = _scope;
