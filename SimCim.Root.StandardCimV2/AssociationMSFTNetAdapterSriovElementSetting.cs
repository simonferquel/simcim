...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterSriovElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterSriovSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterSriovSettingData inSettingData)
        {
            var scope = _scope;
