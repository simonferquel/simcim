...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetConSecRuleFiltersAssociation
    {
        ...
        public IEnumerable<CIMFilterEntryBase> PartComponent(MSFTNetConSecRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetConSecRule> GroupComponent(CIMFilterEntryBase inPartComponent)
        {
            var scope = _scope;
