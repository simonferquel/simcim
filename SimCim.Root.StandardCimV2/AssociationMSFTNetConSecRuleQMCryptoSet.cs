...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetConSecRuleQMCryptoSetAssociation
    {
        ...
        public IEnumerable<MSFTNetIKEQMCryptoSet> PartComponent(MSFTNetConSecRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetConSecRule> GroupComponent(MSFTNetIKEQMCryptoSet inPartComponent)
        {
            var scope = _scope;
