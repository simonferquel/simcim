...
{
    public struct CIMDeviceSAPImplementationAssociation
    {
        private static AssociationResolver _resolver = new AssociationResolver("CIM_DeviceSAPImplementation", "CIM_LogicalDevice", "CIM_ServiceAccessPoint", "Antecedent", "Dependent");
        private IInfrastructureObjectScope _scope;
        public CIMDeviceSAPImplementationAssociation(IInfrastructureObjectScope scope)
        {
            _scope = scope;
        }

        public IEnumerable<CIMServiceAccessPoint> Dependent(CIMLogicalDevice inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMLogicalDevice> Antecedent(CIMServiceAccessPoint inDependent)
        {
            var scope = _scope;
