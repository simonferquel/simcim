...
{
    public class MSFTNetIKEQMCryptoSet : MSFTNetIKECryptoSet
    {
        public MSFTNetIKEQMCryptoSet()
        {
        }

        public MSFTNetIKEQMCryptoSet(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }

        public System.UInt16? PfsGroupID
        {
            get
            {
