...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterLsoElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterLsoSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterLsoSettingData inSettingData)
        {
            var scope = _scope;
