...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetFirewallRuleFilterByInterfaceAssociation
    {
        ...
        public IEnumerable<MSFTNetInterfaceFilter> PartComponent(MSFTNetFirewallRule inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetFirewallRule> GroupComponent(MSFTNetInterfaceFilter inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
