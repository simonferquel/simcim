...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetFirewallRuleFilterByServiceAssociation
    {
        ...
        public IEnumerable<MSFTNetServiceFilter> PartComponent(MSFTNetFirewallRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetFirewallRule> GroupComponent(MSFTNetServiceFilter inPartComponent)
        {
            var scope = _scope;
