...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetLbfoTeamTeamMemberAssociation
    {
        ...
        public IEnumerable<MSFTNetLbfoTeamMember> PartComponent(MSFTNetLbfoTeam inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetLbfoTeam> GroupComponent(MSFTNetLbfoTeamMember inPartComponent)
        {
            var scope = _scope;
