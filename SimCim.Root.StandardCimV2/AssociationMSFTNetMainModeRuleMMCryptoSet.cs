...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetMainModeRuleMMCryptoSetAssociation
    {
        ...
        public IEnumerable<MSFTNetIKEMMCryptoSet> PartComponent(MSFTNetMainModeRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetMainModeRule> GroupComponent(MSFTNetIKEMMCryptoSet inPartComponent)
        {
            var scope = _scope;
