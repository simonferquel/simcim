...
{
    public class MSFTNetAdapterLsoEncapsulationTypes : GenericInfrastructureObject
    {
        public MSFTNetAdapterLsoEncapsulationTypes()
        {
        }

        public MSFTNetAdapterLsoEncapsulationTypes(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
