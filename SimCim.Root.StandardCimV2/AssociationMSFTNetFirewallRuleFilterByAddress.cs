...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetFirewallRuleFilterByAddressAssociation
    {
        ...
        public IEnumerable<MSFTNetAddressFilter> PartComponent(MSFTNetFirewallRule inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetFirewallRule> GroupComponent(MSFTNetAddressFilter inPartComponent)
        {
            var scope = _scope;
