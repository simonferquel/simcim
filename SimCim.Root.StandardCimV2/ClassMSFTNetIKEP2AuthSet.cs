...
{
    public class MSFTNetIKEP2AuthSet : MSFTNetIKEAuthSet
    {
        public MSFTNetIKEP2AuthSet()
        {
        }

        public MSFTNetIKEP2AuthSet(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
