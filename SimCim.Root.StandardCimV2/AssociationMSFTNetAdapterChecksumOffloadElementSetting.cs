...
namespace SimCim.Root.StandardCimV2
{
    public struct MSFTNetAdapterChecksumOffloadElementSettingAssociation
    {
        ...
        public IEnumerable<MSFTNetAdapterChecksumOffloadSettingData> SettingData(MSFTNetAdapter inManagedElement)
        {
            var scope = _scope;
        ...
        public IEnumerable<MSFTNetAdapter> ManagedElement(MSFTNetAdapterChecksumOffloadSettingData inSettingData)
        {
            var scope = _scope;
