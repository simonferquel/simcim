...
{
    public class Win32PerfFormattedDataNvspSwitchProcStatsHyperVVirtualSwitchProcessor : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNvspSwitchProcStatsHyperVVirtualSwitchProcessor()
        {
        }

        public Win32PerfFormattedDataNvspSwitchProcStatsHyperVVirtualSwitchProcessor(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
