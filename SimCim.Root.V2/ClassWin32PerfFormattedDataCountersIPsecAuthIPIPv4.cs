...
{
    public class Win32PerfFormattedDataCountersIPsecAuthIPIPv4 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersIPsecAuthIPIPv4()
        {
        }

        public Win32PerfFormattedDataCountersIPsecAuthIPIPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
