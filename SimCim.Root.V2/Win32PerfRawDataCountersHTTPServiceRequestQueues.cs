...
{
    public class Win32PerfRawDataCountersHTTPServiceRequestQueues : Win32PerfRawData
    {
        public Win32PerfRawDataCountersHTTPServiceRequestQueues()
        {
        }

        public Win32PerfRawDataCountersHTTPServiceRequestQueues(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
