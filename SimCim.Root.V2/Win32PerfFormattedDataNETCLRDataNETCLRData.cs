...
{
    public class Win32PerfFormattedDataNETCLRDataNETCLRData : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNETCLRDataNETCLRData()
        {
        }

        public Win32PerfFormattedDataNETCLRDataNETCLRData(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
