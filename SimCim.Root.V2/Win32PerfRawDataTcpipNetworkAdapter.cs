...
{
    public class Win32PerfRawDataTcpipNetworkAdapter : Win32PerfRawData
    {
        public Win32PerfRawDataTcpipNetworkAdapter()
        {
        }

        public Win32PerfRawDataTcpipNetworkAdapter(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
