...
{
    public class Win32PerfFormattedDataTcpipUDPv4 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataTcpipUDPv4()
        {
        }

        public Win32PerfFormattedDataTcpipUDPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
