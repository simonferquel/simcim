...
{
    public class Win32PerfFormattedDataPerfProcJobObject : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfProcJobObject()
        {
        }

        public Win32PerfFormattedDataPerfProcJobObject(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
