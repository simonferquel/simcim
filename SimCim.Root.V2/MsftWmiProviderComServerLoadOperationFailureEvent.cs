...
{
    public class MsftWmiProviderComServerLoadOperationFailureEvent : MsftWmiProviderOperationEvent
    {
        public MsftWmiProviderComServerLoadOperationFailureEvent()
        {
        }

        public MsftWmiProviderComServerLoadOperationFailureEvent(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
