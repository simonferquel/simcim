...
{
    public class Win32PerfFormattedDataCountersDNS64Global : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersDNS64Global()
        {
        }

        public Win32PerfFormattedDataCountersDNS64Global(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
