...
{
    public class Win32PerfRawDataTcpipICMP : Win32PerfRawData
    {
        public Win32PerfRawDataTcpipICMP()
        {
        }

        public Win32PerfRawDataTcpipICMP(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
