...
{
    public class Win32PerfRawDataDdmCounterProviderRAS : Win32PerfRawData
    {
        public Win32PerfRawDataDdmCounterProviderRAS()
        {
        }

        public Win32PerfRawDataDdmCounterProviderRAS(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
