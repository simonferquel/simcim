...
{
    public class Win32PerfRawDataWinNatCountersWinNATUDP : Win32PerfRawData
    {
        public Win32PerfRawDataWinNatCountersWinNATUDP()
        {
        }

        public Win32PerfRawDataWinNatCountersWinNATUDP(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
