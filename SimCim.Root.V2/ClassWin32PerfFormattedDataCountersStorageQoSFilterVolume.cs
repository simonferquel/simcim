...
{
    public class Win32PerfFormattedDataCountersStorageQoSFilterVolume : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersStorageQoSFilterVolume()
        {
        }

        public Win32PerfFormattedDataCountersStorageQoSFilterVolume(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
