...
{
    public class Win32PerfFormattedDataCountersPacerPipe : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersPacerPipe()
        {
        }

        public Win32PerfFormattedDataCountersPacerPipe(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
