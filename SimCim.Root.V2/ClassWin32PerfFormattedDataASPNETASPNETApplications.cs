...
{
    public class Win32PerfFormattedDataASPNETASPNETApplications : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataASPNETASPNETApplications()
        {
        }

        public Win32PerfFormattedDataASPNETASPNETApplications(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
