...
namespace SimCim.Root.V2
{
    public struct Win32SystemLoadOrderGroupsAssociation
    {
        ...
        public IEnumerable<Win32LoadOrderGroup> PartComponent(Win32ComputerSystem inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(Win32LoadOrderGroup inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
