...
{
    public class Win32PerfRawDataBITSBITSNetUtilization : Win32PerfRawData
    {
        public Win32PerfRawDataBITSBITSNetUtilization()
        {
        }

        public Win32PerfRawDataBITSBITSNetUtilization(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
