...
namespace SimCim.Root.V2
{
    public class Win32ShadowCopy : CIMLogicalElement
    {
        ...
        public (System.UInt32 retval, System.String outShadowID) Create(System.String inContext, System.String inVolume)
        {
            ...
            parameters.Add(CimMethodParameter.Create("Context", inContext, inContext == null ? CimFlags.NullValue : CimFlags.None));
        ...
        public Win32Volume ResolveWin32ShadowForAntecedent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_ShadowFor", "Win32_Volume", "Dependent", "Antecedent");
            return instances.Select(i => (Win32Volume)InfrastuctureObjectScope.Mapper.Create(i)).SingleOrDefault();
        }

        public Win32Volume ResolveWin32ShadowOnAntecedent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_ShadowOn", "Win32_Volume", "Dependent", "Antecedent");
            return instances.Select(i => (Win32Volume)InfrastuctureObjectScope.Mapper.Create(i)).SingleOrDefault();
        }

        public Win32ShadowProvider ResolveWin32ShadowByAntecedent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_ShadowBy", "Win32_ShadowProvider", "Dependent", "Antecedent");
