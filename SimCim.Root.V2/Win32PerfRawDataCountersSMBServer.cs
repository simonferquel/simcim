...
{
    public class Win32PerfRawDataCountersSMBServer : Win32PerfRawData
    {
        public Win32PerfRawDataCountersSMBServer()
        {
        }

        public Win32PerfRawDataCountersSMBServer(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
