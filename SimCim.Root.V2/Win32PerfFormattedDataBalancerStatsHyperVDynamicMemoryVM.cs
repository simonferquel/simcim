...
{
    public class Win32PerfFormattedDataBalancerStatsHyperVDynamicMemoryVM : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataBalancerStatsHyperVDynamicMemoryVM()
        {
        }

        public Win32PerfFormattedDataBalancerStatsHyperVDynamicMemoryVM(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
