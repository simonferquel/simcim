...
namespace SimCim.Root.V2
{
    public abstract class CIMProcess : CIMLogicalElement
    {
        ...
        public CIMDataFile ResolveCIMProcessExecutableAntecedent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "CIM_ProcessExecutable", "CIM_DataFile", "Dependent", "Antecedent");
