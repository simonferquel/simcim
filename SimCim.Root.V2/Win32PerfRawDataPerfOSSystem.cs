...
{
    public class Win32PerfRawDataPerfOSSystem : Win32PerfRawData
    {
        public Win32PerfRawDataPerfOSSystem()
        {
        }

        public Win32PerfRawDataPerfOSSystem(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? PercentRegistryQuotaInUseBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("PercentRegistryQuotaInUse_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("PercentRegistryQuotaInUse_Base", value);
            }
        }
