...
{
    public class Win32PerfFormattedDataWindowsWorkflowFoundation4000WFSystemWorkflow4000 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataWindowsWorkflowFoundation4000WFSystemWorkflow4000()
        {
        }

        public Win32PerfFormattedDataWindowsWorkflowFoundation4000WFSystemWorkflow4000(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
