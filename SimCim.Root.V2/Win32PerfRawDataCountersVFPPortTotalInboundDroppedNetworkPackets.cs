...
{
    public class Win32PerfRawDataCountersVFPPortTotalInboundDroppedNetworkPackets : Win32PerfRawData
    {
        public Win32PerfRawDataCountersVFPPortTotalInboundDroppedNetworkPackets()
        {
        }

        public Win32PerfRawDataCountersVFPPortTotalInboundDroppedNetworkPackets(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
