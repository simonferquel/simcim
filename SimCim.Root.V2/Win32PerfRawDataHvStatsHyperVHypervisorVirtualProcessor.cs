...
{
    public class Win32PerfRawDataHvStatsHyperVHypervisorVirtualProcessor : Win32PerfRawData
    {
        public Win32PerfRawDataHvStatsHyperVHypervisorVirtualProcessor()
        {
        }

        public Win32PerfRawDataHvStatsHyperVHypervisorVirtualProcessor(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
