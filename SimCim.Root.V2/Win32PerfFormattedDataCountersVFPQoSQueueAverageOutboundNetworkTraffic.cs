...
{
    public class Win32PerfFormattedDataCountersVFPQoSQueueAverageOutboundNetworkTraffic : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersVFPQoSQueueAverageOutboundNetworkTraffic()
        {
        }

        public Win32PerfFormattedDataCountersVFPQoSQueueAverageOutboundNetworkTraffic(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
