...
{
    public class Win32PerfRawDataPerfDiskLogicalDisk : Win32PerfRawData
    {
        public Win32PerfRawDataPerfDiskLogicalDisk()
        {
        }

        public Win32PerfRawDataPerfDiskLogicalDisk(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? PercentFreeSpaceBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("PercentFreeSpace_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("PercentFreeSpace_Base", value);
            }
        }
