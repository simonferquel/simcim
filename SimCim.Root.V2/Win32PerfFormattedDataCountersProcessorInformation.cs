...
{
    public class Win32PerfFormattedDataCountersProcessorInformation : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersProcessorInformation()
        {
        }

        public Win32PerfFormattedDataCountersProcessorInformation(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
