...
{
    public class Win32PerfRawDataCountersVFPPortAverageOutboundNetworkTraffic : Win32PerfRawData
    {
        public Win32PerfRawDataCountersVFPPortAverageOutboundNetworkTraffic()
        {
        }

        public Win32PerfRawDataCountersVFPPortAverageOutboundNetworkTraffic(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
