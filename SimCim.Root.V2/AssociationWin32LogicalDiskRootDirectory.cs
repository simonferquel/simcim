...
namespace SimCim.Root.V2
{
    public struct Win32LogicalDiskRootDirectoryAssociation
    {
        ...
        public IEnumerable<Win32Directory> PartComponent(Win32LogicalDisk inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32LogicalDisk> GroupComponent(Win32Directory inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
