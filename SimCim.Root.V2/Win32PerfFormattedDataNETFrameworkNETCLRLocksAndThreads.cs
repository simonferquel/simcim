...
{
    public class Win32PerfFormattedDataNETFrameworkNETCLRLocksAndThreads : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNETFrameworkNETCLRLocksAndThreads()
        {
        }

        public Win32PerfFormattedDataNETFrameworkNETCLRLocksAndThreads(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
