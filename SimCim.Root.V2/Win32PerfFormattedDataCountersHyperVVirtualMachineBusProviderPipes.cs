...
{
    public class Win32PerfFormattedDataCountersHyperVVirtualMachineBusProviderPipes : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersHyperVVirtualMachineBusProviderPipes()
        {
        }

        public Win32PerfFormattedDataCountersHyperVVirtualMachineBusProviderPipes(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
