...
{
    public class Win32PerfRawDataTcpipNetworkInterface : Win32PerfRawData
    {
        public Win32PerfRawDataTcpipNetworkInterface()
        {
        }

        public Win32PerfRawDataTcpipNetworkInterface(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
