...
{
    public class Win32PerfFormattedDataNETDataProviderforOracleNETDataProviderforOracle : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNETDataProviderforOracleNETDataProviderforOracle()
        {
        }

        public Win32PerfFormattedDataNETDataProviderforOracleNETDataProviderforOracle(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
