...
{
    public class Win32PerfFormattedDataPerfProcJobObjectDetails : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfProcJobObjectDetails()
        {
        }

        public Win32PerfFormattedDataPerfProcJobObjectDetails(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
