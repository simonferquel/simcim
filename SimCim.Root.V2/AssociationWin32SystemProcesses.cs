...
namespace SimCim.Root.V2
{
    public struct Win32SystemProcessesAssociation
    {
        ...
        public IEnumerable<Win32Process> PartComponent(Win32ComputerSystem inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(Win32Process inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
