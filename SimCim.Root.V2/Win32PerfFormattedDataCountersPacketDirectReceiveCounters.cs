...
{
    public class Win32PerfFormattedDataCountersPacketDirectReceiveCounters : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersPacketDirectReceiveCounters()
        {
        }

        public Win32PerfFormattedDataCountersPacketDirectReceiveCounters(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
