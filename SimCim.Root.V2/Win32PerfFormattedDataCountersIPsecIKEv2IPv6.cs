...
{
    public class Win32PerfFormattedDataCountersIPsecIKEv2IPv6 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersIPsecIKEv2IPv6()
        {
        }

        public Win32PerfFormattedDataCountersIPsecIKEv2IPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
