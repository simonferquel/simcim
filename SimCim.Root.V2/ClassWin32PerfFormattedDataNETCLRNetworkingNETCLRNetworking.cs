...
{
    public class Win32PerfFormattedDataNETCLRNetworkingNETCLRNetworking : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNETCLRNetworkingNETCLRNetworking()
        {
        }

        public Win32PerfFormattedDataNETCLRNetworkingNETCLRNetworking(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
