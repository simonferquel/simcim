...
{
    public class MsftWmiProviderExecQueryAsyncEventPre : MsftWmiProviderOperationEventPre
    {
        public MsftWmiProviderExecQueryAsyncEventPre()
        {
        }

        public MsftWmiProviderExecQueryAsyncEventPre(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
