...
{
    public class Win32PerfFormattedDataCountersVFPPortTotalInboundNetworkTraffic : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersVFPPortTotalInboundNetworkTraffic()
        {
        }

        public Win32PerfFormattedDataCountersVFPPortTotalInboundNetworkTraffic(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
