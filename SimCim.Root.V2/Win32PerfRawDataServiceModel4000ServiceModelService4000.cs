...
{
    public class Win32PerfRawDataServiceModel4000ServiceModelService4000 : Win32PerfRawData
    {
        public Win32PerfRawDataServiceModel4000ServiceModelService4000()
        {
        }

        public Win32PerfRawDataServiceModel4000ServiceModelService4000(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? PercentOfMaxConcurrentCallsBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("PercentOfMaxConcurrentCalls_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("PercentOfMaxConcurrentCalls_Base", value);
            }
        }
        ...
        public System.UInt32? PercentOfMaxConcurrentInstancesBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("PercentOfMaxConcurrentInstances_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("PercentOfMaxConcurrentInstances_Base", value);
            }
        }
        ...
        public System.UInt32? PercentOfMaxConcurrentSessionsBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("PercentOfMaxConcurrentSessions_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("PercentOfMaxConcurrentSessions_Base", value);
            }
        }
