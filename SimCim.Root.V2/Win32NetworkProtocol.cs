...
namespace SimCim.Root.V2
{
    public class Win32NetworkProtocol : CIMLogicalElement
    {
        ...
        public Win32NetworkAdapter ResolveWin32ProtocolBindingDevice()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_ProtocolBinding", "Win32_NetworkAdapter", "Antecedent", "Device");
