...
namespace SimCim.Root.V2
{
    public class Win32Patch : Win32MSIResource
    {
        ...
        public Win32FileSpecification ResolveWin32PatchFileCheck()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_PatchFile", "Win32_FileSpecification", "Setting", "Check");
            return instances.Select(i => (Win32FileSpecification)InfrastuctureObjectScope.Mapper.Create(i)).SingleOrDefault();
        }
    }
}