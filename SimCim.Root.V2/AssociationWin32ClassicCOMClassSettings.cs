...
namespace SimCim.Root.V2
{
    public struct Win32ClassicCOMClassSettingsAssociation
    {
        ...
        public IEnumerable<Win32ClassicCOMClassSetting> Setting(Win32ClassicCOMClass inElement, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ClassicCOMClass> Element(Win32ClassicCOMClassSetting inSetting, CimOperationOptions options = null)
        {
            var scope = _scope;
