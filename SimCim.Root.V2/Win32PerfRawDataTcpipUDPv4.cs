...
{
    public class Win32PerfRawDataTcpipUDPv4 : Win32PerfRawData
    {
        public Win32PerfRawDataTcpipUDPv4()
        {
        }

        public Win32PerfRawDataTcpipUDPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
