...
{
    public class Win32PerfRawDataTermServiceTerminalServicesSession : Win32PerfRawData
    {
        public Win32PerfRawDataTermServiceTerminalServicesSession()
        {
        }

        public Win32PerfRawDataTermServiceTerminalServicesSession(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
