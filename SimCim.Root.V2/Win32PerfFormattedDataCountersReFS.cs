...
{
    public class Win32PerfFormattedDataCountersReFS : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersReFS()
        {
        }

        public Win32PerfFormattedDataCountersReFS(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
