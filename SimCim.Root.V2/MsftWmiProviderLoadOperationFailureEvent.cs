...
{
    public class MsftWmiProviderLoadOperationFailureEvent : MsftWmiProviderOperationEvent
    {
        public MsftWmiProviderLoadOperationFailureEvent()
        {
        }

        public MsftWmiProviderLoadOperationFailureEvent(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
