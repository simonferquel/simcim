...
{
    public class Win32PerfRawDataNETDataProviderforOracleNETDataProviderforOracle : Win32PerfRawData
    {
        public Win32PerfRawDataNETDataProviderforOracleNETDataProviderforOracle()
        {
        }

        public Win32PerfRawDataNETDataProviderforOracleNETDataProviderforOracle(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
