...
namespace SimCim.Root.V2
{
    public struct Win32SystemResourcesAssociation
    {
        ...
        public IEnumerable<CIMSystemResource> PartComponent(Win32ComputerSystem inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(CIMSystemResource inPartComponent)
        {
            var scope = _scope;
