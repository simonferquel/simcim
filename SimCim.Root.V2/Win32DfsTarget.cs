...
namespace SimCim.Root.V2
{
    public class Win32DfsTarget : CIMLogicalElement
    {
        ...
        public Win32DfsNode ResolveWin32DfsNodeTargetDependent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_DfsNodeTarget", "Win32_DfsNode", "Antecedent", "Dependent");
            return instances.Select(i => (Win32DfsNode)InfrastuctureObjectScope.Mapper.Create(i)).SingleOrDefault();
        }
    }
}