...
{
    public class MsftWmiProviderAccessCheckPost : MsftWmiProviderOperationEventPost
    {
        public MsftWmiProviderAccessCheckPost()
        {
        }

        public MsftWmiProviderAccessCheckPost(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
