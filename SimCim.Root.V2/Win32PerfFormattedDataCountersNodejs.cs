...
{
    public class Win32PerfFormattedDataCountersNodejs : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersNodejs()
        {
        }

        public Win32PerfFormattedDataCountersNodejs(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
