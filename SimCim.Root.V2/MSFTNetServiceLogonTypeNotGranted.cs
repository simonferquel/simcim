...
{
    public class MSFTNetServiceLogonTypeNotGranted : MSFTSCMEventLogEvent
    {
        public MSFTNetServiceLogonTypeNotGranted()
        {
        }

        public MSFTNetServiceLogonTypeNotGranted(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
