...
{
    public class Win32PerfFormattedDataHvStatsHyperVHypervisorLogicalProcessor : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataHvStatsHyperVHypervisorLogicalProcessor()
        {
        }

        public Win32PerfFormattedDataHvStatsHyperVHypervisorLogicalProcessor(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
