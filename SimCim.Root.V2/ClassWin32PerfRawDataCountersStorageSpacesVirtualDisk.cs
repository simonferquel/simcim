...
{
    public class Win32PerfRawDataCountersStorageSpacesVirtualDisk : Win32PerfRawData
    {
        public Win32PerfRawDataCountersStorageSpacesVirtualDisk()
        {
        }

        public Win32PerfRawDataCountersStorageSpacesVirtualDisk(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
