...
{
    public class Win32PerfFormattedDataCountersSMBServerShares : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersSMBServerShares()
        {
        }

        public Win32PerfFormattedDataCountersSMBServerShares(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
