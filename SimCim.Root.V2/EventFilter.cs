...
namespace SimCim.Root.V2
{
    public class EventFilter : IndicationRelated
    {
        ...
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "__FilterToConsumerBinding", "__EventConsumer", "Filter", "Consumer");
