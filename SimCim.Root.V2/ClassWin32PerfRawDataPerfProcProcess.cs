...
namespace SimCim.Root.V2
{
    ...
    {
        public Win32PerfRawDataPerfProcProcess()
        {
        }

        public Win32PerfRawDataPerfProcProcess(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
