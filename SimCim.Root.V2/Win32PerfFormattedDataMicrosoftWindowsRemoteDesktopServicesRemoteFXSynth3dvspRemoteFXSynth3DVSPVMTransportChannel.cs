...
{
    public class Win32PerfFormattedDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMTransportChannel : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMTransportChannel()
        {
        }

        public Win32PerfFormattedDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMTransportChannel(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
