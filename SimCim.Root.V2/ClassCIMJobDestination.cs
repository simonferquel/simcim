...
{
    public abstract class CIMJobDestination : CIMLogicalElement
    {
        protected CIMJobDestination()
        {
        }

        protected CIMJobDestination(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
