...
namespace SimCim.Root.V2
{
    public class Win32NamedJobObjectSecLimitSetting : CIMSetting
    {
        ...
        public Win32NamedJobObject ResolveWin32NamedJobObjectSecLimitCollection()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_NamedJobObjectSecLimit", "Win32_NamedJobObject", "Setting", "Collection");
