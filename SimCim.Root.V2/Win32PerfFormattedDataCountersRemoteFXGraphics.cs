...
{
    public class Win32PerfFormattedDataCountersRemoteFXGraphics : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersRemoteFXGraphics()
        {
        }

        public Win32PerfFormattedDataCountersRemoteFXGraphics(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
