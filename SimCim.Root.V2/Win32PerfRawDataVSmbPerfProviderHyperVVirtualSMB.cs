...
{
    public class Win32PerfRawDataVSmbPerfProviderHyperVVirtualSMB : Win32PerfRawData
    {
        public Win32PerfRawDataVSmbPerfProviderHyperVVirtualSMB()
        {
        }

        public Win32PerfRawDataVSmbPerfProviderHyperVVirtualSMB(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
