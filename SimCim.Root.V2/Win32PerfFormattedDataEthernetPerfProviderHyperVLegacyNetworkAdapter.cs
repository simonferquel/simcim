...
{
    public class Win32PerfFormattedDataEthernetPerfProviderHyperVLegacyNetworkAdapter : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataEthernetPerfProviderHyperVLegacyNetworkAdapter()
        {
        }

        public Win32PerfFormattedDataEthernetPerfProviderHyperVLegacyNetworkAdapter(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
