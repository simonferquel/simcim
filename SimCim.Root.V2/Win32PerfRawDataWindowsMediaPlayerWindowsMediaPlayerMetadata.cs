...
{
    public class Win32PerfRawDataWindowsMediaPlayerWindowsMediaPlayerMetadata : Win32PerfRawData
    {
        public Win32PerfRawDataWindowsMediaPlayerWindowsMediaPlayerMetadata()
        {
        }

        public Win32PerfRawDataWindowsMediaPlayerWindowsMediaPlayerMetadata(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? FilesScannedPerMinuteBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("FilesScannedPerMinute_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("FilesScannedPerMinute_Base", value);
            }
        }
        ...
        public System.UInt32? GrovelerServiceRoutineExecutionsPerSecondBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("GrovelerServiceRoutineExecutionsPerSecond_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("GrovelerServiceRoutineExecutionsPerSecond_Base", value);
            }
        }
        ...
        public System.UInt32? LibraryDescriptionChangeNotificationsPerSecondBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("LibraryDescriptionChangeNotificationsPerSecond_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("LibraryDescriptionChangeNotificationsPerSecond_Base", value);
            }
        }
        ...
        public System.UInt32? LibraryDescriptionUpdatesPerSecondBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("LibraryDescriptionUpdatesPerSecond_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("LibraryDescriptionUpdatesPerSecond_Base", value);
            }
        }
        ...
        public System.UInt32? MonitoredFolderUpdatesPerSecondBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("MonitoredFolderUpdatesPerSecond_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("MonitoredFolderUpdatesPerSecond_Base", value);
            }
        }
