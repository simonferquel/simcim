...
{
    public class Win32PerfFormattedDataHyperVReplicaStatsHyperVReplicaVM : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataHyperVReplicaStatsHyperVReplicaVM()
        {
        }

        public Win32PerfFormattedDataHyperVReplicaStatsHyperVReplicaVM(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
