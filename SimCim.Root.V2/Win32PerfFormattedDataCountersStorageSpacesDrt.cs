...
{
    public class Win32PerfFormattedDataCountersStorageSpacesDrt : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersStorageSpacesDrt()
        {
        }

        public Win32PerfFormattedDataCountersStorageSpacesDrt(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
