...
{
    public class Win32PerfFormattedDataCountersStorageQoSFilterFlow : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersStorageQoSFilterFlow()
        {
        }

        public Win32PerfFormattedDataCountersStorageQoSFilterFlow(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
