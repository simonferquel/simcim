...
{
    public class Win32PerfRawDataCountersVFPPortTotalOutboundNetworkTraffic : Win32PerfRawData
    {
        public Win32PerfRawDataCountersVFPPortTotalOutboundNetworkTraffic()
        {
        }

        public Win32PerfRawDataCountersVFPPortTotalOutboundNetworkTraffic(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
