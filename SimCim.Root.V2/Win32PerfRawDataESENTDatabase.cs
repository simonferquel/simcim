...
{
    public class Win32PerfRawDataESENTDatabase : Win32PerfRawData
    {
        public Win32PerfRawDataESENTDatabase()
        {
        }

        public Win32PerfRawDataESENTDatabase(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? DatabaseCachePercentDehydratedBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("DatabaseCachePercentDehydrated_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("DatabaseCachePercentDehydrated_Base", value);
            }
        }
