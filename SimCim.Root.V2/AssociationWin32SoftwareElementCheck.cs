...
namespace SimCim.Root.V2
{
    public struct Win32SoftwareElementCheckAssociation
    {
        ...
        public IEnumerable<Win32SoftwareElement> Element(CIMCheck inCheck, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMCheck> Check(Win32SoftwareElement inElement, CimOperationOptions options = null)
        {
            var scope = _scope;
