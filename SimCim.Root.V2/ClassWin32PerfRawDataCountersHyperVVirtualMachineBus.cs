...
{
    public class Win32PerfRawDataCountersHyperVVirtualMachineBus : Win32PerfRawData
    {
        public Win32PerfRawDataCountersHyperVVirtualMachineBus()
        {
        }

        public Win32PerfRawDataCountersHyperVVirtualMachineBus(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
