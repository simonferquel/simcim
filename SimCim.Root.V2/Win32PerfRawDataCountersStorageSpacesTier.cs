...
{
    public class Win32PerfRawDataCountersStorageSpacesTier : Win32PerfRawData
    {
        public Win32PerfRawDataCountersStorageSpacesTier()
        {
        }

        public Win32PerfRawDataCountersStorageSpacesTier(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? TierReadBytesAverageBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("TierReadBytesAverage_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("TierReadBytesAverage_Base", value);
            }
        }
        ...
        public System.UInt32? TierReadLatencyBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("TierReadLatency_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("TierReadLatency_Base", value);
            }
        }
        ...
        public System.UInt32? TierTransferBytesAverageBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("TierTransferBytesAverage_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("TierTransferBytesAverage_Base", value);
            }
        }
        ...
        public System.UInt32? TierTransferLatencyBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("TierTransferLatency_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("TierTransferLatency_Base", value);
            }
        }
        ...
        public System.UInt32? TierWriteBytesAverageBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("TierWriteBytesAverage_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("TierWriteBytesAverage_Base", value);
            }
        }
        ...
        public System.UInt32? TierWriteLatencyBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("TierWriteLatency_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("TierWriteLatency_Base", value);
            }
        }
