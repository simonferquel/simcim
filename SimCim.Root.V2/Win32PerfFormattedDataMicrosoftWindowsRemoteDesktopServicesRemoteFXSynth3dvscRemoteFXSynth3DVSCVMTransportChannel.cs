...
{
    public class Win32PerfFormattedDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvscRemoteFXSynth3DVSCVMTransportChannel : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvscRemoteFXSynth3DVSCVMTransportChannel()
        {
        }

        public Win32PerfFormattedDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvscRemoteFXSynth3DVSCVMTransportChannel(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
