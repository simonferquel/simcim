...
{
    public class Win32PerfFormattedDataAFDCountersMicrosoftWinsockBSP : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataAFDCountersMicrosoftWinsockBSP()
        {
        }

        public Win32PerfFormattedDataAFDCountersMicrosoftWinsockBSP(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
