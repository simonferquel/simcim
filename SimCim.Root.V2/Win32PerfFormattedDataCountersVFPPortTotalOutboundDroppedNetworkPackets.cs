...
{
    public class Win32PerfFormattedDataCountersVFPPortTotalOutboundDroppedNetworkPackets : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersVFPPortTotalOutboundDroppedNetworkPackets()
        {
        }

        public Win32PerfFormattedDataCountersVFPPortTotalOutboundDroppedNetworkPackets(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
