...
{
    public class Win32PerfRawDataCountersHyperVVirtualMachineBusProviderPipes : Win32PerfRawData
    {
        public Win32PerfRawDataCountersHyperVVirtualMachineBusProviderPipes()
        {
        }

        public Win32PerfRawDataCountersHyperVVirtualMachineBusProviderPipes(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
