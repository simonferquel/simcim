...
{
    public class Win32PerfRawDataCountersSynchronizationNuma : Win32PerfRawData
    {
        public Win32PerfRawDataCountersSynchronizationNuma()
        {
        }

        public Win32PerfRawDataCountersSynchronizationNuma(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
