...
{
    public class Win32PerfFormattedDataCountersPerProcessorNetworkInterfaceCardActivity : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersPerProcessorNetworkInterfaceCardActivity()
        {
        }

        public Win32PerfFormattedDataCountersPerProcessorNetworkInterfaceCardActivity(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
