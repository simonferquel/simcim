...
{
    public class Win32PerfFormattedDataESENTDatabaseInstances : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataESENTDatabaseInstances()
        {
        }

        public Win32PerfFormattedDataESENTDatabaseInstances(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
