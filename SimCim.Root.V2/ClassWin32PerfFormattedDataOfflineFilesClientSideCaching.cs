...
{
    public class Win32PerfFormattedDataOfflineFilesClientSideCaching : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataOfflineFilesClientSideCaching()
        {
        }

        public Win32PerfFormattedDataOfflineFilesClientSideCaching(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
