...
{
    public class Win32PerfFormattedDataCountersEventLog : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersEventLog()
        {
        }

        public Win32PerfFormattedDataCountersEventLog(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
