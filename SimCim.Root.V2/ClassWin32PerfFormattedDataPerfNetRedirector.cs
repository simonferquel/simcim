...
{
    public class Win32PerfFormattedDataPerfNetRedirector : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfNetRedirector()
        {
        }

        public Win32PerfFormattedDataPerfNetRedirector(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
