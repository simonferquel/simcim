...
{
    public class Win32PerfFormattedDataUsbhubNoname : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataUsbhubNoname()
        {
        }

        public Win32PerfFormattedDataUsbhubNoname(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
