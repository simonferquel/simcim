...
{
    public class Win32PerfRawDataCountersIPsecDriver : Win32PerfRawData
    {
        public Win32PerfRawDataCountersIPsecDriver()
        {
        }

        public Win32PerfRawDataCountersIPsecDriver(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
