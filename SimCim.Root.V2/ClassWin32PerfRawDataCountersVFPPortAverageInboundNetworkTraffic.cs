...
{
    public class Win32PerfRawDataCountersVFPPortAverageInboundNetworkTraffic : Win32PerfRawData
    {
        public Win32PerfRawDataCountersVFPPortAverageInboundNetworkTraffic()
        {
        }

        public Win32PerfRawDataCountersVFPPortAverageInboundNetworkTraffic(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
