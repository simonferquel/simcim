...
{
    public class Win32PerfRawDataVMBusPipeIOPerfProviderHyperVVMVirtualDevicePipeIO : Win32PerfRawData
    {
        public Win32PerfRawDataVMBusPipeIOPerfProviderHyperVVMVirtualDevicePipeIO()
        {
        }

        public Win32PerfRawDataVMBusPipeIOPerfProviderHyperVVMVirtualDevicePipeIO(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
