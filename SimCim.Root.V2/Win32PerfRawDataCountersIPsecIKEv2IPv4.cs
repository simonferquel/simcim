...
{
    public class Win32PerfRawDataCountersIPsecIKEv2IPv4 : Win32PerfRawData
    {
        public Win32PerfRawDataCountersIPsecIKEv2IPv4()
        {
        }

        public Win32PerfRawDataCountersIPsecIKEv2IPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
