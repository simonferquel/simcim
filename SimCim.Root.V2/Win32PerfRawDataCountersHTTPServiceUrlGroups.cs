...
{
    public class Win32PerfRawDataCountersHTTPServiceUrlGroups : Win32PerfRawData
    {
        public Win32PerfRawDataCountersHTTPServiceUrlGroups()
        {
        }

        public Win32PerfRawDataCountersHTTPServiceUrlGroups(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
