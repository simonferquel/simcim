...
{
    public class Win32PerfRawDataCountersSMBDirectConnection : Win32PerfRawData
    {
        public Win32PerfRawDataCountersSMBDirectConnection()
        {
        }

        public Win32PerfRawDataCountersSMBDirectConnection(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
