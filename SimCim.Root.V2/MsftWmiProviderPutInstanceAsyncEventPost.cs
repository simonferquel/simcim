...
{
    public class MsftWmiProviderPutInstanceAsyncEventPost : MsftWmiProviderOperationEventPost
    {
        public MsftWmiProviderPutInstanceAsyncEventPost()
        {
        }

        public MsftWmiProviderPutInstanceAsyncEventPost(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
