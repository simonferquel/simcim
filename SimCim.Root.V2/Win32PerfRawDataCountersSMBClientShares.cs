...
{
    public class Win32PerfRawDataCountersSMBClientShares : Win32PerfRawData
    {
        public Win32PerfRawDataCountersSMBClientShares()
        {
        }

        public Win32PerfRawDataCountersSMBClientShares(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
