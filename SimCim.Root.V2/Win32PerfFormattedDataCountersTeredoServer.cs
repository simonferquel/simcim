...
{
    public class Win32PerfFormattedDataCountersTeredoServer : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersTeredoServer()
        {
        }

        public Win32PerfFormattedDataCountersTeredoServer(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
