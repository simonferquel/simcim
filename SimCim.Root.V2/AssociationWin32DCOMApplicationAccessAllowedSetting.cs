...
{
    public struct Win32DCOMApplicationAccessAllowedSettingAssociation
    {
        private static AssociationResolver _resolver = new AssociationResolver("Win32_DCOMApplicationAccessAllowedSetting", "Win32_DCOMApplication", "Win32_SID", "Element", "Setting");
        private IInfrastructureObjectScope _scope;
        public Win32DCOMApplicationAccessAllowedSettingAssociation(IInfrastructureObjectScope scope)
        {
            _scope = scope;
        }

        public IEnumerable<Win32SID> Setting(Win32DCOMApplication inElement, CimOperationOptions options = null)
        {
            var scope = _scope;
