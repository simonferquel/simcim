...
{
    public class Win32PerfFormattedDataPerfOSCache : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfOSCache()
        {
        }

        public Win32PerfFormattedDataPerfOSCache(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
