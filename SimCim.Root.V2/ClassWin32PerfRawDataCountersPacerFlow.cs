...
{
    public class Win32PerfRawDataCountersPacerFlow : Win32PerfRawData
    {
        public Win32PerfRawDataCountersPacerFlow()
        {
        }

        public Win32PerfRawDataCountersPacerFlow(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
