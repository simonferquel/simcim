...
{
    public class Win32PerfRawDataCountersTeredoClient : Win32PerfRawData
    {
        public Win32PerfRawDataCountersTeredoClient()
        {
        }

        public Win32PerfRawDataCountersTeredoClient(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
