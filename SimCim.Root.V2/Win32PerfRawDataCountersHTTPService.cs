...
{
    public class Win32PerfRawDataCountersHTTPService : Win32PerfRawData
    {
        public Win32PerfRawDataCountersHTTPService()
        {
        }

        public Win32PerfRawDataCountersHTTPService(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
