...
{
    public class Win32PerfFormattedDataCountersBluetoothRadio : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersBluetoothRadio()
        {
        }

        public Win32PerfFormattedDataCountersBluetoothRadio(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
