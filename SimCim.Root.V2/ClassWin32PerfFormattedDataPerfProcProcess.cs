...
{
    public class Win32PerfFormattedDataPerfProcProcess : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfProcProcess()
        {
        }

        public Win32PerfFormattedDataPerfProcProcess(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }

        public System.UInt32? CreatingProcessID
        {
            get
            {
        ...
        public System.UInt64? WorkingSetPrivate
        {
            get
            {
                System.UInt64? result;
                this.GetProperty("WorkingSetPrivate", out result);
                return result;
            }

            set
            {
                this.SetProperty("WorkingSetPrivate", value);
            }
        }
    }
}