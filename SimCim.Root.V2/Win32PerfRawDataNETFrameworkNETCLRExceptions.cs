...
{
    public class Win32PerfRawDataNETFrameworkNETCLRExceptions : Win32PerfRawData
    {
        public Win32PerfRawDataNETFrameworkNETCLRExceptions()
        {
        }

        public Win32PerfRawDataNETFrameworkNETCLRExceptions(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
