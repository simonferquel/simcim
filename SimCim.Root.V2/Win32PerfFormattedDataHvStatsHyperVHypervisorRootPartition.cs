...
{
    public class Win32PerfFormattedDataHvStatsHyperVHypervisorRootPartition : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataHvStatsHyperVHypervisorRootPartition()
        {
        }

        public Win32PerfFormattedDataHvStatsHyperVHypervisorRootPartition(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
