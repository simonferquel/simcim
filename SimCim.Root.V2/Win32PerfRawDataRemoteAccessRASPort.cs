...
{
    public class Win32PerfRawDataRemoteAccessRASPort : Win32PerfRawData
    {
        public Win32PerfRawDataRemoteAccessRASPort()
        {
        }

        public Win32PerfRawDataRemoteAccessRASPort(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
