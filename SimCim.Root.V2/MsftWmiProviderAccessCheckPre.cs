...
{
    public class MsftWmiProviderAccessCheckPre : MsftWmiProviderOperationEventPre
    {
        public MsftWmiProviderAccessCheckPre()
        {
        }

        public MsftWmiProviderAccessCheckPre(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
