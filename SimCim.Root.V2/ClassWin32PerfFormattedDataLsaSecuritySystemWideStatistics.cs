...
{
    public class Win32PerfFormattedDataLsaSecuritySystemWideStatistics : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataLsaSecuritySystemWideStatistics()
        {
        }

        public Win32PerfFormattedDataLsaSecuritySystemWideStatistics(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
