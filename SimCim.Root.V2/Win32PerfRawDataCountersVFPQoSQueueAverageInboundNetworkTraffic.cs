...
{
    public class Win32PerfRawDataCountersVFPQoSQueueAverageInboundNetworkTraffic : Win32PerfRawData
    {
        public Win32PerfRawDataCountersVFPQoSQueueAverageInboundNetworkTraffic()
        {
        }

        public Win32PerfRawDataCountersVFPQoSQueueAverageInboundNetworkTraffic(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
