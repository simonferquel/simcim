...
namespace SimCim.Root.V2
{
    public class Win32NTDomain : CIMSystem
    {
        ...
        public IEnumerable<Win32UserAccount> ResolveWin32UserInDomainPartComponent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_UserInDomain", "Win32_UserAccount", "GroupComponent", "PartComponent");
            return instances.Select(i => (Win32UserAccount)InfrastuctureObjectScope.Mapper.Create(i));
        }

        public IEnumerable<Win32Group> ResolveWin32GroupInDomainPartComponent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_GroupInDomain", "Win32_Group", "GroupComponent", "PartComponent");
