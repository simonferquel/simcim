...
namespace SimCim.Root.V2
{
    public struct Win32LoadOrderGroupServiceDependenciesAssociation
    {
        ...
        public IEnumerable<Win32BaseService> Dependent(Win32LoadOrderGroup inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32LoadOrderGroup> Antecedent(Win32BaseService inDependent)
        {
            var scope = _scope;
