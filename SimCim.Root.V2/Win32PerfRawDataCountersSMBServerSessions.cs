...
{
    public class Win32PerfRawDataCountersSMBServerSessions : Win32PerfRawData
    {
        public Win32PerfRawDataCountersSMBServerSessions()
        {
        }

        public Win32PerfRawDataCountersSMBServerSessions(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
