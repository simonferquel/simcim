...
{
    public class Win32PerfRawDataWorkflowServiceHost4000WorkflowServiceHost4000 : Win32PerfRawData
    {
        public Win32PerfRawDataWorkflowServiceHost4000WorkflowServiceHost4000()
        {
        }

        public Win32PerfRawDataWorkflowServiceHost4000WorkflowServiceHost4000(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? AverageWorkflowLoadTimeBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("AverageWorkflowLoadTime_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("AverageWorkflowLoadTime_Base", value);
            }
        }
        ...
        public System.UInt32? AverageWorkflowPersistTimeBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("AverageWorkflowPersistTime_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("AverageWorkflowPersistTime_Base", value);
            }
        }
