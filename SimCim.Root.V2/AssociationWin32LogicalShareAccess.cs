...
{
    public struct Win32LogicalShareAccessAssociation
    {
        private static AssociationResolver _resolver = new AssociationResolver("Win32_LogicalShareAccess", "Win32_LogicalShareSecuritySetting", "Win32_SID", "SecuritySetting", "Trustee");
        private IInfrastructureObjectScope _scope;
        public Win32LogicalShareAccessAssociation(IInfrastructureObjectScope scope)
        {
            _scope = scope;
        }
