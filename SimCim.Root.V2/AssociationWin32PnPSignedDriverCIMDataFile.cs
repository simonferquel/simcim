...
namespace SimCim.Root.V2
{
    public struct Win32PnPSignedDriverCIMDataFileAssociation
    {
        ...
        public IEnumerable<CIMDataFile> Dependent(Win32PnPSignedDriver inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32PnPSignedDriver> Antecedent(CIMDataFile inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
