...
{
    public class Win32PerfFormattedDataTermServiceTerminalServicesSession : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataTermServiceTerminalServicesSession()
        {
        }

        public Win32PerfFormattedDataTermServiceTerminalServicesSession(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
