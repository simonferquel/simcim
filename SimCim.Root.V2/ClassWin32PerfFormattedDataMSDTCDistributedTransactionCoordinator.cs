...
{
    public class Win32PerfFormattedDataMSDTCDistributedTransactionCoordinator : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataMSDTCDistributedTransactionCoordinator()
        {
        }

        public Win32PerfFormattedDataMSDTCDistributedTransactionCoordinator(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
