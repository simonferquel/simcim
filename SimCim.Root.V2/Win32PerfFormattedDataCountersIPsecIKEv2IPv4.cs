...
{
    public class Win32PerfFormattedDataCountersIPsecIKEv2IPv4 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersIPsecIKEv2IPv4()
        {
        }

        public Win32PerfFormattedDataCountersIPsecIKEv2IPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
