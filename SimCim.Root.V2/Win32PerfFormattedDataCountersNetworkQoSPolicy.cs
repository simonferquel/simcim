...
{
    public class Win32PerfFormattedDataCountersNetworkQoSPolicy : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersNetworkQoSPolicy()
        {
        }

        public Win32PerfFormattedDataCountersNetworkQoSPolicy(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
