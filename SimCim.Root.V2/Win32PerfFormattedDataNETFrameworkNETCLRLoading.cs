...
{
    public class Win32PerfFormattedDataNETFrameworkNETCLRLoading : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNETFrameworkNETCLRLoading()
        {
        }

        public Win32PerfFormattedDataNETFrameworkNETCLRLoading(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
