...
namespace SimCim.Root.V2
{
    public class Win32ShortcutAction : CIMAction
    {
        ...
        public Win32CommandLineAccess ResolveWin32ShortcutSAPElement()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_ShortcutSAP", "Win32_CommandLineAccess", "Action", "Element");
