...
{
    public class Win32PerfRawDataCountersWFPv4 : Win32PerfRawData
    {
        public Win32PerfRawDataCountersWFPv4()
        {
        }

        public Win32PerfRawDataCountersWFPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
