...
{
    public class Win32PerfRawDataCountersXHCIInterrupter : Win32PerfRawData
    {
        public Win32PerfRawDataCountersXHCIInterrupter()
        {
        }

        public Win32PerfRawDataCountersXHCIInterrupter(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? EventsprocessedDPCBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("EventsprocessedDPC_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("EventsprocessedDPC_Base", value);
            }
        }
