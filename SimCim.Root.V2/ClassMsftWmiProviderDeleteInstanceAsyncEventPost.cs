...
{
    public class MsftWmiProviderDeleteInstanceAsyncEventPost : MsftWmiProviderOperationEventPost
    {
        public MsftWmiProviderDeleteInstanceAsyncEventPost()
        {
        }

        public MsftWmiProviderDeleteInstanceAsyncEventPost(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
