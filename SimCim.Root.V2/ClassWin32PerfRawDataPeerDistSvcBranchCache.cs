...
{
    public class Win32PerfRawDataPeerDistSvcBranchCache : Win32PerfRawData
    {
        public Win32PerfRawDataPeerDistSvcBranchCache()
        {
        }

        public Win32PerfRawDataPeerDistSvcBranchCache(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
