...
{
    public class Win32PerfFormattedDataCountersIPsecAuthIPIPv6 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersIPsecAuthIPIPv6()
        {
        }

        public Win32PerfFormattedDataCountersIPsecAuthIPIPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
