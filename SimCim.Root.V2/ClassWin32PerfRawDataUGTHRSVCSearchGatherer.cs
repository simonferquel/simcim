...
{
    public class Win32PerfRawDataUGTHRSVCSearchGatherer : Win32PerfRawData
    {
        public Win32PerfRawDataUGTHRSVCSearchGatherer()
        {
        }

        public Win32PerfRawDataUGTHRSVCSearchGatherer(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
