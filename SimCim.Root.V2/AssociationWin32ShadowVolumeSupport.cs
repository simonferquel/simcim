...
{
    public struct Win32ShadowVolumeSupportAssociation
    {
        private static AssociationResolver _resolver = new AssociationResolver("Win32_ShadowVolumeSupport", "Win32_ShadowProvider", "Win32_Volume", "Antecedent", "Dependent");
        private IInfrastructureObjectScope _scope;
        public Win32ShadowVolumeSupportAssociation(IInfrastructureObjectScope scope)
        {
            _scope = scope;
        }

        public IEnumerable<Win32Volume> Dependent(Win32ShadowProvider inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ShadowProvider> Antecedent(Win32Volume inDependent)
        {
            var scope = _scope;
