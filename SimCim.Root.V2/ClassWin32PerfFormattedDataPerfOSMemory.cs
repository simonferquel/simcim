...
{
    public class Win32PerfFormattedDataPerfOSMemory : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfOSMemory()
        {
        }

        public Win32PerfFormattedDataPerfOSMemory(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
