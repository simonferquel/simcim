...
{
    public class Win32PerfFormattedDataTcpipTCPv6 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataTcpipTCPv6()
        {
        }

        public Win32PerfFormattedDataTcpipTCPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
