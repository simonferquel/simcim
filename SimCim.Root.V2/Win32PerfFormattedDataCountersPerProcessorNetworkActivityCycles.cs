...
{
    public class Win32PerfFormattedDataCountersPerProcessorNetworkActivityCycles : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersPerProcessorNetworkActivityCycles()
        {
        }

        public Win32PerfFormattedDataCountersPerProcessorNetworkActivityCycles(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
