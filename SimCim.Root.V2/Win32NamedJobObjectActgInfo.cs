...
namespace SimCim.Root.V2
{
    public class Win32NamedJobObjectActgInfo : CIMStatisticalInformation
    {
        ...
        public Win32NamedJobObject ResolveWin32NamedJobObjectStatisticsCollection()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_NamedJobObjectStatistics", "Win32_NamedJobObject", "Stats", "Collection");
