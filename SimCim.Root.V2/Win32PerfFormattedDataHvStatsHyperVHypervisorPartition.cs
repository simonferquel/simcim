...
{
    public class Win32PerfFormattedDataHvStatsHyperVHypervisorPartition : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataHvStatsHyperVHypervisorPartition()
        {
        }

        public Win32PerfFormattedDataHvStatsHyperVHypervisorPartition(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
