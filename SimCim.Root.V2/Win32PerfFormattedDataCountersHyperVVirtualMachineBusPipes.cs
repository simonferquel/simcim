...
{
    public class Win32PerfFormattedDataCountersHyperVVirtualMachineBusPipes : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersHyperVVirtualMachineBusPipes()
        {
        }

        public Win32PerfFormattedDataCountersHyperVVirtualMachineBusPipes(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
