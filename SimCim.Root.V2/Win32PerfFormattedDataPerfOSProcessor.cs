...
{
    public class Win32PerfFormattedDataPerfOSProcessor : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfOSProcessor()
        {
        }

        public Win32PerfFormattedDataPerfOSProcessor(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
