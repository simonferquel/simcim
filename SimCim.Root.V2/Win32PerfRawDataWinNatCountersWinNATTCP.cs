...
{
    public class Win32PerfRawDataWinNatCountersWinNATTCP : Win32PerfRawData
    {
        public Win32PerfRawDataWinNatCountersWinNATTCP()
        {
        }

        public Win32PerfRawDataWinNatCountersWinNATTCP(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
