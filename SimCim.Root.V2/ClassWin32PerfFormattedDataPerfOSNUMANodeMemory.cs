...
{
    public class Win32PerfFormattedDataPerfOSNUMANodeMemory : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfOSNUMANodeMemory()
        {
        }

        public Win32PerfFormattedDataPerfOSNUMANodeMemory(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
