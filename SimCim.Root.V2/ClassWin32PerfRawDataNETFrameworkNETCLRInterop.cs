...
{
    public class Win32PerfRawDataNETFrameworkNETCLRInterop : Win32PerfRawData
    {
        public Win32PerfRawDataNETFrameworkNETCLRInterop()
        {
        }

        public Win32PerfRawDataNETFrameworkNETCLRInterop(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
