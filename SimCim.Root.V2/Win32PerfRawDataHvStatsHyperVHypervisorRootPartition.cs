...
{
    public class Win32PerfRawDataHvStatsHyperVHypervisorRootPartition : Win32PerfRawData
    {
        public Win32PerfRawDataHvStatsHyperVHypervisorRootPartition()
        {
        }

        public Win32PerfRawDataHvStatsHyperVHypervisorRootPartition(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
