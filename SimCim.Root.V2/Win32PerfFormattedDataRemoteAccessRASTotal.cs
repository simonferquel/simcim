...
{
    public class Win32PerfFormattedDataRemoteAccessRASTotal : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataRemoteAccessRASTotal()
        {
        }

        public Win32PerfFormattedDataRemoteAccessRASTotal(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? TotalConnections
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("TotalConnections", out result);
                return result;
            }

            set
            {
                this.SetProperty("TotalConnections", value);
            }
        }
