...
{
    public class Win32PerfRawDataCountersIPsecIKEv1IPv4 : Win32PerfRawData
    {
        public Win32PerfRawDataCountersIPsecIKEv1IPv4()
        {
        }

        public Win32PerfRawDataCountersIPsecIKEv1IPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
