...
{
    public class Win32PerfRawDataCountersEventTracingforWindowsSession : Win32PerfRawData
    {
        public Win32PerfRawDataCountersEventTracingforWindowsSession()
        {
        }

        public Win32PerfRawDataCountersEventTracingforWindowsSession(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
