...
{
    public class Win32PerfFormattedDataHvStatsHyperVHypervisorVirtualProcessor : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataHvStatsHyperVHypervisorVirtualProcessor()
        {
        }

        public Win32PerfFormattedDataHvStatsHyperVHypervisorVirtualProcessor(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
