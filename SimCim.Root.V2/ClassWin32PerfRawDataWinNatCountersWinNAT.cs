...
{
    public class Win32PerfRawDataWinNatCountersWinNAT : Win32PerfRawData
    {
        public Win32PerfRawDataWinNatCountersWinNAT()
        {
        }

        public Win32PerfRawDataWinNatCountersWinNAT(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
