...
{
    public class Win32PerfFormattedDataGPUPerformanceCountersGPUProcessMemory : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataGPUPerformanceCountersGPUProcessMemory()
        {
        }

        public Win32PerfFormattedDataGPUPerformanceCountersGPUProcessMemory(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
