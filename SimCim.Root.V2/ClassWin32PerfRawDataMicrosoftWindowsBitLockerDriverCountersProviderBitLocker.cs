...
{
    public class Win32PerfRawDataMicrosoftWindowsBitLockerDriverCountersProviderBitLocker : Win32PerfRawData
    {
        public Win32PerfRawDataMicrosoftWindowsBitLockerDriverCountersProviderBitLocker()
        {
        }

        public Win32PerfRawDataMicrosoftWindowsBitLockerDriverCountersProviderBitLocker(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
