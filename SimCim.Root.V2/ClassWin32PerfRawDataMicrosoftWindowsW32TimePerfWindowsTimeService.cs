...
{
    public class Win32PerfRawDataMicrosoftWindowsW32TimePerfWindowsTimeService : Win32PerfRawData
    {
        public Win32PerfRawDataMicrosoftWindowsW32TimePerfWindowsTimeService()
        {
        }

        public Win32PerfRawDataMicrosoftWindowsW32TimePerfWindowsTimeService(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
