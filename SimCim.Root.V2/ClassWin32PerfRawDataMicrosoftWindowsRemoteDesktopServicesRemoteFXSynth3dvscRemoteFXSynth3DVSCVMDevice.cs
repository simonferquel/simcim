...
{
    public class Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvscRemoteFXSynth3DVSCVMDevice : Win32PerfRawData
    {
        public Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvscRemoteFXSynth3DVSCVMDevice()
        {
        }

        public Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvscRemoteFXSynth3DVSCVMDevice(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
