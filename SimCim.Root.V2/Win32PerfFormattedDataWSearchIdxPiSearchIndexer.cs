...
{
    public class Win32PerfFormattedDataWSearchIdxPiSearchIndexer : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataWSearchIdxPiSearchIndexer()
        {
        }

        public Win32PerfFormattedDataWSearchIdxPiSearchIndexer(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
