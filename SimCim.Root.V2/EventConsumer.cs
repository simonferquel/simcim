...
namespace SimCim.Root.V2
{
    public abstract class EventConsumer : IndicationRelated
    {
        ...
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "__FilterToConsumerBinding", "__EventFilter", "Consumer", "Filter");
