...
{
    public class Win32PerfFormattedDataAspnetstateASPNETStateService : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataAspnetstateASPNETStateService()
        {
        }

        public Win32PerfFormattedDataAspnetstateASPNETStateService(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
