...
{
    public class Win32PerfRawDataNETFrameworkNETCLRMemory : Win32PerfRawData
    {
        public Win32PerfRawDataNETFrameworkNETCLRMemory()
        {
        }

        public Win32PerfRawDataNETFrameworkNETCLRMemory(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? PercentTimeinGCBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("PercentTimeinGC_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("PercentTimeinGC_Base", value);
            }
        }
