...
{
    public class Win32PerfFormattedDataNETFrameworkNETCLRRemoting : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNETFrameworkNETCLRRemoting()
        {
        }

        public Win32PerfFormattedDataNETFrameworkNETCLRRemoting(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
