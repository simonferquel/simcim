...
{
    public class Win32PerfFormattedDataPerfNetBrowser : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfNetBrowser()
        {
        }

        public Win32PerfFormattedDataPerfNetBrowser(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
