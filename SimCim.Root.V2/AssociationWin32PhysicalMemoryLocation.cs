...
namespace SimCim.Root.V2
{
    public struct Win32PhysicalMemoryLocationAssociation
    {
        ...
        public IEnumerable<Win32PhysicalMemory> PartComponent(Win32PhysicalMemoryArray inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32PhysicalMemoryArray> GroupComponent(Win32PhysicalMemory inPartComponent)
        {
            var scope = _scope;
