...
namespace SimCim.Root.V2
{
    public class Win32ServiceSpecification : CIMCheck
    {
        ...
        public Win32Service ResolveWin32ServiceSpecificationServiceElement()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_ServiceSpecificationService", "Win32_Service", "Check", "Element");
