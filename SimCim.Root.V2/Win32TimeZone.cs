...
namespace SimCim.Root.V2
{
    public class Win32TimeZone : CIMSetting
    {
        ...
        public Win32ComputerSystem ResolveWin32SystemTimeZoneElement()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_SystemTimeZone", "Win32_ComputerSystem", "Setting", "Element");
