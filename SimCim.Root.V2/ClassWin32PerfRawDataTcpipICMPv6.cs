...
{
    public class Win32PerfRawDataTcpipICMPv6 : Win32PerfRawData
    {
        public Win32PerfRawDataTcpipICMPv6()
        {
        }

        public Win32PerfRawDataTcpipICMPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
