...
namespace SimCim.Root.V2
{
    public struct Win32SystemBIOSAssociation
    {
        ...
        public IEnumerable<Win32BIOS> PartComponent(Win32ComputerSystem inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(Win32BIOS inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
