...
namespace SimCim.Root.V2
{
    public struct Win32PrinterShareAssociation
    {
        ...
        public IEnumerable<Win32Share> Dependent(Win32Printer inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32Printer> Antecedent(Win32Share inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
