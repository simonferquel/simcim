...
{
    public class Win32PerfFormattedDataNvspNicVRSSStatsHyperVVirtualNetworkAdapterVRSS : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNvspNicVRSSStatsHyperVVirtualNetworkAdapterVRSS()
        {
        }

        public Win32PerfFormattedDataNvspNicVRSSStatsHyperVVirtualNetworkAdapterVRSS(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
