...
{
    public class Win32PerfRawDataRemoteAccessRASTotal : Win32PerfRawData
    {
        public Win32PerfRawDataRemoteAccessRASTotal()
        {
        }

        public Win32PerfRawDataRemoteAccessRASTotal(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
