...
namespace SimCim.Root.V2
{
    public class Win32NamedJobObjectLimitSetting : CIMSetting
    {
        ...
        public Win32NamedJobObject ResolveWin32NamedJobObjectLimitCollection()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_NamedJobObjectLimit", "Win32_NamedJobObject", "Setting", "Collection");
