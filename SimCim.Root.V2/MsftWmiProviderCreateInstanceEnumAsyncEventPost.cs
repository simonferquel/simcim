...
{
    public class MsftWmiProviderCreateInstanceEnumAsyncEventPost : MsftWmiProviderOperationEventPost
    {
        public MsftWmiProviderCreateInstanceEnumAsyncEventPost()
        {
        }

        public MsftWmiProviderCreateInstanceEnumAsyncEventPost(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
