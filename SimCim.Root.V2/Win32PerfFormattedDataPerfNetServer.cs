...
{
    public class Win32PerfFormattedDataPerfNetServer : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfNetServer()
        {
        }

        public Win32PerfFormattedDataPerfNetServer(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
