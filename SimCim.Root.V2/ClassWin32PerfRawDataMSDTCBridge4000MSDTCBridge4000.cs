...
{
    public class Win32PerfRawDataMSDTCBridge4000MSDTCBridge4000 : Win32PerfRawData
    {
        public Win32PerfRawDataMSDTCBridge4000MSDTCBridge4000()
        {
        }

        public Win32PerfRawDataMSDTCBridge4000MSDTCBridge4000(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? AverageparticipantcommitresponsetimeBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("Averageparticipantcommitresponsetime_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("Averageparticipantcommitresponsetime_Base", value);
            }
        }
        ...
        public System.UInt32? AverageparticipantprepareresponsetimeBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("Averageparticipantprepareresponsetime_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("Averageparticipantprepareresponsetime_Base", value);
            }
        }
