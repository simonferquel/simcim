...
namespace SimCim.Root.V2
{
    public struct Win32SystemUsersAssociation
    {
        ...
        public IEnumerable<Win32UserAccount> PartComponent(Win32ComputerSystem inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(Win32UserAccount inPartComponent)
        {
            var scope = _scope;
