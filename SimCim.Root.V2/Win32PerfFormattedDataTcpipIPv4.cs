...
{
    public class Win32PerfFormattedDataTcpipIPv4 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataTcpipIPv4()
        {
        }

        public Win32PerfFormattedDataTcpipIPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
