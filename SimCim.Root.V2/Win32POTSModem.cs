...
namespace SimCim.Root.V2
{
    public class Win32POTSModem : CIMPotsModem
    {
        ...
        public Win32SerialPort ResolveWin32POTSModemToSerialPortAntecedent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_POTSModemToSerialPort", "Win32_SerialPort", "Dependent", "Antecedent");
