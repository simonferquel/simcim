...
{
    public class Win32PerfFormattedDataCountersIPsecIKEv1IPv4 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersIPsecIKEv1IPv4()
        {
        }

        public Win32PerfFormattedDataCountersIPsecIKEv1IPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
