...
{
    public class Win32PerfFormattedDataRemoteFXPerformanceCounterProviderRemoteFXSoftware : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataRemoteFXPerformanceCounterProviderRemoteFXSoftware()
        {
        }

        public Win32PerfFormattedDataRemoteFXPerformanceCounterProviderRemoteFXSoftware(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
