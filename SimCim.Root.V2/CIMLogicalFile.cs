    ...
    public abstract class CIMLogicalFile : CIMLogicalElement
    {
        ...
        public System.Boolean GetEffectivePermission(System.UInt32? inPermissions)
        {
            ...
            if (inPermissions.HasValue)
                ...
                parameters.Add(CimMethodParameter.Create("Permissions", null, CimFlags.NullValue));
        ...
        public Win32LogicalFileSecuritySetting ResolveWin32SecuritySettingOfLogicalFileSetting()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_SecuritySettingOfLogicalFile", "Win32_LogicalFileSecuritySetting", "Element", "Setting");
