...
{
    public class Win32PerfRawDataCountersBluetoothDevice : Win32PerfRawData
    {
        public Win32PerfRawDataCountersBluetoothDevice()
        {
        }

        public Win32PerfRawDataCountersBluetoothDevice(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
