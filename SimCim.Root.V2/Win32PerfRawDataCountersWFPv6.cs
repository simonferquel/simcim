...
{
    public class Win32PerfRawDataCountersWFPv6 : Win32PerfRawData
    {
        public Win32PerfRawDataCountersWFPv6()
        {
        }

        public Win32PerfRawDataCountersWFPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
