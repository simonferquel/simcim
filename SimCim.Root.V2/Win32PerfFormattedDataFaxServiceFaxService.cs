...
{
    public class Win32PerfFormattedDataFaxServiceFaxService : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataFaxServiceFaxService()
        {
        }

        public Win32PerfFormattedDataFaxServiceFaxService(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
