...
{
    public class MSFTWmiRegisterNotificationSink : MSFTWmiEssEvent
    {
        public MSFTWmiRegisterNotificationSink()
        {
        }

        public MSFTWmiRegisterNotificationSink(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
