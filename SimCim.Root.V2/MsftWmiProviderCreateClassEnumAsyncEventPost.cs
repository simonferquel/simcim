...
{
    public class MsftWmiProviderCreateClassEnumAsyncEventPost : MsftWmiProviderOperationEventPost
    {
        public MsftWmiProviderCreateClassEnumAsyncEventPost()
        {
        }

        public MsftWmiProviderCreateClassEnumAsyncEventPost(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
