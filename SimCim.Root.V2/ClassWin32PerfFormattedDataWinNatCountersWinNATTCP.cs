...
{
    public class Win32PerfFormattedDataWinNatCountersWinNATTCP : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataWinNatCountersWinNATTCP()
        {
        }

        public Win32PerfFormattedDataWinNatCountersWinNATTCP(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
