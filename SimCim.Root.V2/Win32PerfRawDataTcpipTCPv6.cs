...
{
    public class Win32PerfRawDataTcpipTCPv6 : Win32PerfRawData
    {
        public Win32PerfRawDataTcpipTCPv6()
        {
        }

        public Win32PerfRawDataTcpipTCPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
