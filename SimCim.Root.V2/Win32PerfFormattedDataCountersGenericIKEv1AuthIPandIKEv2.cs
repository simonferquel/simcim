...
{
    public class Win32PerfFormattedDataCountersGenericIKEv1AuthIPandIKEv2 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersGenericIKEv1AuthIPandIKEv2()
        {
        }

        public Win32PerfFormattedDataCountersGenericIKEv1AuthIPandIKEv2(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
