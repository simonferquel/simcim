...
{
    public class Win32PerfFormattedDataRdyboostReadyBoostCache : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataRdyboostReadyBoostCache()
        {
        }

        public Win32PerfFormattedDataRdyboostReadyBoostCache(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
