...
{
    public class Win32PerfFormattedDataTcpipIPv6 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataTcpipIPv6()
        {
        }

        public Win32PerfFormattedDataTcpipIPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
