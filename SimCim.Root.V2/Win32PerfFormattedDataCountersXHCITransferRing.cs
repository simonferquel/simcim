...
{
    public class Win32PerfFormattedDataCountersXHCITransferRing : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersXHCITransferRing()
        {
        }

        public Win32PerfFormattedDataCountersXHCITransferRing(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
