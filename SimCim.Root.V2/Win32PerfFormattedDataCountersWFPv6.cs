...
{
    public class Win32PerfFormattedDataCountersWFPv6 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersWFPv6()
        {
        }

        public Win32PerfFormattedDataCountersWFPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
