...
{
    public class Win32PerfRawDataCountersHyperVVirtualStorageDevice : Win32PerfRawData
    {
        public Win32PerfRawDataCountersHyperVVirtualStorageDevice()
        {
        }

        public Win32PerfRawDataCountersHyperVVirtualStorageDevice(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? LatencyBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("Latency_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("Latency_Base", value);
            }
        }
        ...
        public System.UInt32? LowerLatencyBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("LowerLatency_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("LowerLatency_Base", value);
            }
        }
