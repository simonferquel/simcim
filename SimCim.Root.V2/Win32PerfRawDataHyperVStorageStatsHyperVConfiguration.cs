...
{
    public class Win32PerfRawDataHyperVStorageStatsHyperVConfiguration : Win32PerfRawData
    {
        public Win32PerfRawDataHyperVStorageStatsHyperVConfiguration()
        {
        }

        public Win32PerfRawDataHyperVStorageStatsHyperVConfiguration(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
