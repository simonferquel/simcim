...
namespace SimCim.Root.V2
{
    public struct Win32SystemProgramGroupsAssociation
    {
        ...
        public IEnumerable<Win32LogicalProgramGroup> Setting(Win32ComputerSystem inElement, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> Element(Win32LogicalProgramGroup inSetting, CimOperationOptions options = null)
        {
            var scope = _scope;
