...
{
    public class Win32PerfFormattedDataCountersIPsecConnections : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersIPsecConnections()
        {
        }

        public Win32PerfFormattedDataCountersIPsecConnections(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
