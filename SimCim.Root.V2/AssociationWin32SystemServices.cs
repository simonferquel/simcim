...
namespace SimCim.Root.V2
{
    public struct Win32SystemServicesAssociation
    {
        ...
        public IEnumerable<Win32Service> PartComponent(Win32ComputerSystem inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(Win32Service inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
