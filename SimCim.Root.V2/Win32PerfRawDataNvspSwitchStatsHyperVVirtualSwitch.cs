...
{
    public class Win32PerfRawDataNvspSwitchStatsHyperVVirtualSwitch : Win32PerfRawData
    {
        public Win32PerfRawDataNvspSwitchStatsHyperVVirtualSwitch()
        {
        }

        public Win32PerfRawDataNvspSwitchStatsHyperVVirtualSwitch(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
