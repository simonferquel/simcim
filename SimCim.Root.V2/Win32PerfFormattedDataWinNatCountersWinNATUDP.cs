...
{
    public class Win32PerfFormattedDataWinNatCountersWinNATUDP : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataWinNatCountersWinNATUDP()
        {
        }

        public Win32PerfFormattedDataWinNatCountersWinNATUDP(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
