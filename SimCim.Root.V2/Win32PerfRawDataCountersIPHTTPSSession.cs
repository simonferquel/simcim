...
{
    public class Win32PerfRawDataCountersIPHTTPSSession : Win32PerfRawData
    {
        public Win32PerfRawDataCountersIPHTTPSSession()
        {
        }

        public Win32PerfRawDataCountersIPHTTPSSession(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
