...
namespace SimCim.Root.V2
{
    public struct Win32ComputerSystemProcessorAssociation
    {
        ...
        public IEnumerable<Win32Processor> PartComponent(Win32ComputerSystem inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(Win32Processor inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
