...
{
    public class Win32PerfFormattedDataCountersSynchronizationNuma : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersSynchronizationNuma()
        {
        }

        public Win32PerfFormattedDataCountersSynchronizationNuma(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
