...
{
    public class Win32PerfRawDataHvStatsHyperVHypervisor : Win32PerfRawData
    {
        public Win32PerfRawDataHvStatsHyperVHypervisor()
        {
        }

        public Win32PerfRawDataHvStatsHyperVHypervisor(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
