...
{
    public class Win32PerfFormattedDataPeerNameResolutionProtocolPerfPeerNameResolutionProtocol : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPeerNameResolutionProtocolPerfPeerNameResolutionProtocol()
        {
        }

        public Win32PerfFormattedDataPeerNameResolutionProtocolPerfPeerNameResolutionProtocol(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
