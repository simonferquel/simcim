...
{
    public class Win32PerfRawDataPerfProcThread : Win32PerfRawData
    {
        public Win32PerfRawDataPerfProcThread()
        {
        }

        public Win32PerfRawDataPerfProcThread(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
