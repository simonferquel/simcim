...
{
    public class MSFTNetConnectionTimeout : MSFTSCMEventLogEvent
    {
        public MSFTNetConnectionTimeout()
        {
        }

        public MSFTNetConnectionTimeout(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
