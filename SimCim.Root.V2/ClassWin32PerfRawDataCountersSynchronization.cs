...
{
    public class Win32PerfRawDataCountersSynchronization : Win32PerfRawData
    {
        public Win32PerfRawDataCountersSynchronization()
        {
        }

        public Win32PerfRawDataCountersSynchronization(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
