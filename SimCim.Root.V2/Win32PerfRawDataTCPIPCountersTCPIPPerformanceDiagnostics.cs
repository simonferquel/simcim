...
{
    public class Win32PerfRawDataTCPIPCountersTCPIPPerformanceDiagnostics : Win32PerfRawData
    {
        public Win32PerfRawDataTCPIPCountersTCPIPPerformanceDiagnostics()
        {
        }

        public Win32PerfRawDataTCPIPCountersTCPIPPerformanceDiagnostics(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
