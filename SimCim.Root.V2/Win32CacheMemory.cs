...
namespace SimCim.Root.V2
{
    public class Win32CacheMemory : CIMCacheMemory
    {
        ...
        public Win32Processor ResolveWin32AssociatedProcessorMemoryDependent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_AssociatedProcessorMemory", "Win32_Processor", "Antecedent", "Dependent");
            return instances.Select(i => (Win32Processor)InfrastuctureObjectScope.Mapper.Create(i)).SingleOrDefault();
        }
    }
}