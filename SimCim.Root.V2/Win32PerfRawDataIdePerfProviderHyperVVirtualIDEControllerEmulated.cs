...
{
    public class Win32PerfRawDataIdePerfProviderHyperVVirtualIDEControllerEmulated : Win32PerfRawData
    {
        public Win32PerfRawDataIdePerfProviderHyperVVirtualIDEControllerEmulated()
        {
        }

        public Win32PerfRawDataIdePerfProviderHyperVVirtualIDEControllerEmulated(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
