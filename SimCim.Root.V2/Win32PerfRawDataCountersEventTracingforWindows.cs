...
{
    public class Win32PerfRawDataCountersEventTracingforWindows : Win32PerfRawData
    {
        public Win32PerfRawDataCountersEventTracingforWindows()
        {
        }

        public Win32PerfRawDataCountersEventTracingforWindows(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
