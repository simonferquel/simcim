...
{
    public class Win32PerfFormattedDataASPNETASPNET : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataASPNETASPNET()
        {
        }

        public Win32PerfFormattedDataASPNETASPNET(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
