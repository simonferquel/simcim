...
{
    public class Win32PerfRawDataWinNatCountersWinNATICMP : Win32PerfRawData
    {
        public Win32PerfRawDataWinNatCountersWinNATICMP()
        {
        }

        public Win32PerfRawDataWinNatCountersWinNATICMP(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
