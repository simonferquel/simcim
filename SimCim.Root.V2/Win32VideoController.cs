...
namespace SimCim.Root.V2
{
    public class Win32VideoController : CIMPCVideoController
    {
        ...
        public CIMVideoControllerResolution ResolveWin32VideoSettingsSetting()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_VideoSettings", "CIM_VideoControllerResolution", "Element", "Setting");
            return instances.Select(i => (CIMVideoControllerResolution)InfrastuctureObjectScope.Mapper.Create(i)).SingleOrDefault();
        }
    }
}