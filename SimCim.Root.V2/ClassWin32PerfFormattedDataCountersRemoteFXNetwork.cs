...
{
    public class Win32PerfFormattedDataCountersRemoteFXNetwork : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersRemoteFXNetwork()
        {
        }

        public Win32PerfFormattedDataCountersRemoteFXNetwork(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
