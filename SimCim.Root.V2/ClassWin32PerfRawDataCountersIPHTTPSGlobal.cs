...
{
    public class Win32PerfRawDataCountersIPHTTPSGlobal : Win32PerfRawData
    {
        public Win32PerfRawDataCountersIPHTTPSGlobal()
        {
        }

        public Win32PerfRawDataCountersIPHTTPSGlobal(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
