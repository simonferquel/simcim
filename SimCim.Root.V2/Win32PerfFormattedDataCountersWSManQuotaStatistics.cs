...
{
    public class Win32PerfFormattedDataCountersWSManQuotaStatistics : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersWSManQuotaStatistics()
        {
        }

        public Win32PerfFormattedDataCountersWSManQuotaStatistics(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
