...
namespace SimCim.Root.V2
{
    public struct Win32SCSIControllerDeviceAssociation
    {
        ...
        public IEnumerable<CIMLogicalDevice> Dependent(Win32SCSIController inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32SCSIController> Antecedent(CIMLogicalDevice inDependent)
        {
            var scope = _scope;
