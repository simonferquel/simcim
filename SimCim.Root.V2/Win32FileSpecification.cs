...
namespace SimCim.Root.V2
{
    public class Win32FileSpecification : CIMFileSpecification
    {
        ...
        public Win32Patch ResolveWin32PatchFileSetting()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_PatchFile", "Win32_Patch", "Check", "Setting");
            return instances.Select(i => (Win32Patch)InfrastuctureObjectScope.Mapper.Create(i)).SingleOrDefault();
        }
    }
}