...
{
    public class Win32PerfRawDataCountersRDMAActivity : Win32PerfRawData
    {
        public Win32PerfRawDataCountersRDMAActivity()
        {
        }

        public Win32PerfRawDataCountersRDMAActivity(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
