...
{
    public class Win32PerfFormattedDataNETDataProviderforSqlServerNETDataProviderforSqlServer : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNETDataProviderforSqlServerNETDataProviderforSqlServer()
        {
        }

        public Win32PerfFormattedDataNETDataProviderforSqlServerNETDataProviderforSqlServer(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
