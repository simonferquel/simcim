...
{
    public class Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMDevice : Win32PerfRawData
    {
        public Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMDevice()
        {
        }

        public Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMDevice(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
