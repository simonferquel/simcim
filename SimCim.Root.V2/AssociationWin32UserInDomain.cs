...
namespace SimCim.Root.V2
{
    public struct Win32UserInDomainAssociation
    {
        ...
        public IEnumerable<Win32UserAccount> PartComponent(Win32NTDomain inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32NTDomain> GroupComponent(Win32UserAccount inPartComponent)
        {
            var scope = _scope;
