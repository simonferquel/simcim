...
{
    public class Win32PerfFormattedDataCountersPacketDirectTransmitCounters : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersPacketDirectTransmitCounters()
        {
        }

        public Win32PerfFormattedDataCountersPacketDirectTransmitCounters(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
