...
namespace SimCim.Root.V2
{
    public struct Win32PrinterDriverDllAssociation
    {
        ...
        public IEnumerable<Win32Printer> Dependent(CIMDataFile inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMDataFile> Antecedent(Win32Printer inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
