...
{
    public class Win32PerfRawDataCountersIPsecAuthIPIPv6 : Win32PerfRawData
    {
        public Win32PerfRawDataCountersIPsecAuthIPIPv6()
        {
        }

        public Win32PerfRawDataCountersIPsecAuthIPIPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
