...
{
    public class Win32PerfRawDataVidPerfProviderHyperVVMVidPartition : Win32PerfRawData
    {
        public Win32PerfRawDataVidPerfProviderHyperVVMVidPartition()
        {
        }

        public Win32PerfRawDataVidPerfProviderHyperVVMVidPartition(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
