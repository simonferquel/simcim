...
{
    public class Win32PerfRawDataLmPerfProviderHyperVVMLiveMigration : Win32PerfRawData
    {
        public Win32PerfRawDataLmPerfProviderHyperVVMLiveMigration()
        {
        }

        public Win32PerfRawDataLmPerfProviderHyperVVMLiveMigration(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
