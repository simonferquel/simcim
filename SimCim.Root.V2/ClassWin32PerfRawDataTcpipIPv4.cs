...
{
    public class Win32PerfRawDataTcpipIPv4 : Win32PerfRawData
    {
        public Win32PerfRawDataTcpipIPv4()
        {
        }

        public Win32PerfRawDataTcpipIPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
