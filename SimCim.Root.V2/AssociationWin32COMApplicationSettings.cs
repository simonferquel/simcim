...
namespace SimCim.Root.V2
{
    public struct Win32COMApplicationSettingsAssociation
    {
        ...
        public IEnumerable<Win32DCOMApplicationSetting> Setting(Win32DCOMApplication inElement, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32DCOMApplication> Element(Win32DCOMApplicationSetting inSetting, CimOperationOptions options = null)
        {
            var scope = _scope;
