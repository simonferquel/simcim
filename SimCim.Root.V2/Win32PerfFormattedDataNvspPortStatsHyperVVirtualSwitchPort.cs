...
{
    public class Win32PerfFormattedDataNvspPortStatsHyperVVirtualSwitchPort : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNvspPortStatsHyperVVirtualSwitchPort()
        {
        }

        public Win32PerfFormattedDataNvspPortStatsHyperVVirtualSwitchPort(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
