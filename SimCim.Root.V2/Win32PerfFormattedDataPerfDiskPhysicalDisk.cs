...
{
    public class Win32PerfFormattedDataPerfDiskPhysicalDisk : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfDiskPhysicalDisk()
        {
        }

        public Win32PerfFormattedDataPerfDiskPhysicalDisk(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
