...
namespace SimCim.Root.V2
{
    public struct Win32SystemOperatingSystemAssociation
    {
        ...
        public IEnumerable<Win32OperatingSystem> PartComponent(Win32ComputerSystem inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(Win32OperatingSystem inPartComponent)
        {
            var scope = _scope;
