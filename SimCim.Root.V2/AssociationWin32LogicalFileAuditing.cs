...
{
    public struct Win32LogicalFileAuditingAssociation
    {
        private static AssociationResolver _resolver = new AssociationResolver("Win32_LogicalFileAuditing", "Win32_LogicalFileSecuritySetting", "Win32_SID", "SecuritySetting", "Trustee");
        private IInfrastructureObjectScope _scope;
        public Win32LogicalFileAuditingAssociation(IInfrastructureObjectScope scope)
        {
            _scope = scope;
        }

        public IEnumerable<Win32SID> Trustee(Win32LogicalFileSecuritySetting inSecuritySetting, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32LogicalFileSecuritySetting> SecuritySetting(Win32SID inTrustee, CimOperationOptions options = null)
        {
            var scope = _scope;
