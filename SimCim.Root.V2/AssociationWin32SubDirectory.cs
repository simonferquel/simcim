...
namespace SimCim.Root.V2
{
    public struct Win32SubDirectoryAssociation
    {
        ...
        public IEnumerable<Win32Directory> PartComponent(Win32Directory inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32Directory> GroupComponent(Win32Directory inPartComponent)
        {
            var scope = _scope;
