...
{
    public class Win32PerfFormattedDataCountersXHCICommonBuffer : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersXHCICommonBuffer()
        {
        }

        public Win32PerfFormattedDataCountersXHCICommonBuffer(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
