...
{
    public class Win32PerfRawDataCountersWFPClassify : Win32PerfRawData
    {
        public Win32PerfRawDataCountersWFPClassify()
        {
        }

        public Win32PerfRawDataCountersWFPClassify(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
