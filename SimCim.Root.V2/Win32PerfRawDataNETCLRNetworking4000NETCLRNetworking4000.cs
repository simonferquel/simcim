...
{
    public class Win32PerfRawDataNETCLRNetworking4000NETCLRNetworking4000 : Win32PerfRawData
    {
        public Win32PerfRawDataNETCLRNetworking4000NETCLRNetworking4000()
        {
        }

        public Win32PerfRawDataNETCLRNetworking4000NETCLRNetworking4000(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
        ...
        public System.UInt32? HttpWebRequestsAverageLifetimeBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("HttpWebRequestsAverageLifetime_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("HttpWebRequestsAverageLifetime_Base", value);
            }
        }
        ...
        public System.UInt32? HttpWebRequestsAverageQueueTimeBase
        {
            get
            {
                System.UInt32? result;
                this.GetProperty("HttpWebRequestsAverageQueueTime_Base", out result);
                return result;
            }

            set
            {
                this.SetProperty("HttpWebRequestsAverageQueueTime_Base", value);
            }
        }
