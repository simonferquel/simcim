...
{
    public class Win32PerfFormattedDataGmoPerfProviderHyperVVMSaveSnapshotandRestore : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataGmoPerfProviderHyperVVMSaveSnapshotandRestore()
        {
        }

        public Win32PerfFormattedDataGmoPerfProviderHyperVVMSaveSnapshotandRestore(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
