...
{
    public class Win32PerfRawDataCountersPowerShellWorkflow : Win32PerfRawData
    {
        public Win32PerfRawDataCountersPowerShellWorkflow()
        {
        }

        public Win32PerfRawDataCountersPowerShellWorkflow(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
