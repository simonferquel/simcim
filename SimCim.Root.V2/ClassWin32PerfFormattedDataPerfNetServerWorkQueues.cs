...
{
    public class Win32PerfFormattedDataPerfNetServerWorkQueues : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataPerfNetServerWorkQueues()
        {
        }

        public Win32PerfFormattedDataPerfNetServerWorkQueues(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
