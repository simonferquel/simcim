...
{
    public class Win32PerfFormattedDataCountersTeredoRelay : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersTeredoRelay()
        {
        }

        public Win32PerfFormattedDataCountersTeredoRelay(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
