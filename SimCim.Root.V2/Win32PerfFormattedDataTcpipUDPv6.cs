...
{
    public class Win32PerfFormattedDataTcpipUDPv6 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataTcpipUDPv6()
        {
        }

        public Win32PerfFormattedDataTcpipUDPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
