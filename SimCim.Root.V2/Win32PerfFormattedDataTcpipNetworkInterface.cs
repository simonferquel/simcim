...
{
    public class Win32PerfFormattedDataTcpipNetworkInterface : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataTcpipNetworkInterface()
        {
        }

        public Win32PerfFormattedDataTcpipNetworkInterface(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
