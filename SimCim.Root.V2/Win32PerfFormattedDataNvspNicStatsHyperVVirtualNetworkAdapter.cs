...
{
    public class Win32PerfFormattedDataNvspNicStatsHyperVVirtualNetworkAdapter : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataNvspNicStatsHyperVVirtualNetworkAdapter()
        {
        }

        public Win32PerfFormattedDataNvspNicStatsHyperVVirtualNetworkAdapter(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
