...
namespace SimCim.Root.V2
{
    public struct Win32SystemNetworkConnectionsAssociation
    {
        ...
        public IEnumerable<Win32NetworkConnection> PartComponent(Win32ComputerSystem inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ComputerSystem> GroupComponent(Win32NetworkConnection inPartComponent)
        {
            var scope = _scope;
