...
{
    public class Win32PerfRawDataDistributedRoutingTablePerfDistributedRoutingTable : Win32PerfRawData
    {
        public Win32PerfRawDataDistributedRoutingTablePerfDistributedRoutingTable()
        {
        }

        public Win32PerfRawDataDistributedRoutingTablePerfDistributedRoutingTable(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
