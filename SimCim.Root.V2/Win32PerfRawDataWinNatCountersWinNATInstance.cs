...
{
    public class Win32PerfRawDataWinNatCountersWinNATInstance : Win32PerfRawData
    {
        public Win32PerfRawDataWinNatCountersWinNATInstance()
        {
        }

        public Win32PerfRawDataWinNatCountersWinNATInstance(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
