...
namespace SimCim.Root.V2
{
    public struct Win32AssociatedProcessorMemoryAssociation
    {
        ...
        public IEnumerable<Win32Processor> Dependent(Win32CacheMemory inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32CacheMemory> Antecedent(Win32Processor inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
