...
{
    public class Win32PerfRawDataUGathererSearchGathererProjects : Win32PerfRawData
    {
        public Win32PerfRawDataUGathererSearchGathererProjects()
        {
        }

        public Win32PerfRawDataUGathererSearchGathererProjects(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
