...
{
    public class Win32PerfFormattedDataCountersPacketDirectReceiveFilters : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersPacketDirectReceiveFilters()
        {
        }

        public Win32PerfFormattedDataCountersPacketDirectReceiveFilters(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
