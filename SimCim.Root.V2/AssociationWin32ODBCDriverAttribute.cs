...
namespace SimCim.Root.V2
{
    public struct Win32ODBCDriverAttributeAssociation
    {
        ...
        public IEnumerable<Win32ODBCAttribute> Setting(Win32ODBCDriverSpecification inCheck, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<Win32ODBCDriverSpecification> Check(Win32ODBCAttribute inSetting, CimOperationOptions options = null)
        {
            var scope = _scope;
