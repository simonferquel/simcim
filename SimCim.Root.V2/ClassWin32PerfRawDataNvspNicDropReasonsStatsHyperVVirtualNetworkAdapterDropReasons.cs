...
{
    public class Win32PerfRawDataNvspNicDropReasonsStatsHyperVVirtualNetworkAdapterDropReasons : Win32PerfRawData
    {
        public Win32PerfRawDataNvspNicDropReasonsStatsHyperVVirtualNetworkAdapterDropReasons()
        {
        }

        public Win32PerfRawDataNvspNicDropReasonsStatsHyperVVirtualNetworkAdapterDropReasons(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
