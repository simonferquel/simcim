...
{
    public class Win32PerfRawDataTcpipNBTConnection : Win32PerfRawData
    {
        public Win32PerfRawDataTcpipNBTConnection()
        {
        }

        public Win32PerfRawDataTcpipNBTConnection(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
