...
{
    public class Win32PerfFormattedDataTcpipTCPv4 : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataTcpipTCPv4()
        {
        }

        public Win32PerfFormattedDataTcpipTCPv4(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
