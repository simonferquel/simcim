...
{
    public class Win32PerfRawDataCountersIPsecIKEv1IPv6 : Win32PerfRawData
    {
        public Win32PerfRawDataCountersIPsecIKEv1IPv6()
        {
        }

        public Win32PerfRawDataCountersIPsecIKEv1IPv6(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
