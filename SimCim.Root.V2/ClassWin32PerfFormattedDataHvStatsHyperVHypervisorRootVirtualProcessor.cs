...
{
    public class Win32PerfFormattedDataHvStatsHyperVHypervisorRootVirtualProcessor : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataHvStatsHyperVHypervisorRootVirtualProcessor()
        {
        }

        public Win32PerfFormattedDataHvStatsHyperVHypervisorRootVirtualProcessor(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
