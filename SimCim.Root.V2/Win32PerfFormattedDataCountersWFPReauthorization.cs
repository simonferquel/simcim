...
{
    public class Win32PerfFormattedDataCountersWFPReauthorization : Win32PerfFormattedData
    {
        public Win32PerfFormattedDataCountersWFPReauthorization()
        {
        }

        public Win32PerfFormattedDataCountersWFPReauthorization(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
