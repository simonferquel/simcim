...
{
    public class Win32PerfRawDataSpoolerPrintQueue : Win32PerfRawData
    {
        public Win32PerfRawDataSpoolerPrintQueue()
        {
        }

        public Win32PerfRawDataSpoolerPrintQueue(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
