...
namespace SimCim.Root.V2
{
    public class Win32ServerConnection : CIMLogicalElement
    {
        ...
        public Win32ServerSession ResolveWin32SessionConnectionAntecedent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_SessionConnection", "Win32_ServerSession", "Dependent", "Antecedent");
            return instances.Select(i => (Win32ServerSession)InfrastuctureObjectScope.Mapper.Create(i)).SingleOrDefault();
        }

        public Win32Share ResolveWin32ConnectionShareAntecedent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/cimv2", InnerCimInstance, "Win32_ConnectionShare", "Win32_Share", "Dependent", "Antecedent");
