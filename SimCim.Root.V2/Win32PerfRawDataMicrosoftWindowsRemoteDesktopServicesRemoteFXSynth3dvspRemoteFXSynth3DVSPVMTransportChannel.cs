...
{
    public class Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMTransportChannel : Win32PerfRawData
    {
        public Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMTransportChannel()
        {
        }

        public Win32PerfRawDataMicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvspRemoteFXSynth3DVSPVMTransportChannel(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
