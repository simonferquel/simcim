...
namespace SimCim.Root.Virtualization.V2
{
    public abstract class CIMResourcePoolConfigurationService : CIMService
    {
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob, CIMResourcePool outPool) CreateResourcePool(System.String inElementName, IEnumerable<CIMLogicalDevice> inHostResources, System.String inResourceType)
        {
            ...
            parameters.Add(CimMethodParameter.Create("ElementName", inElementName, inElementName == null ? CimFlags.NullValue : CimFlags.None));
            parameters.Add(CimMethodParameter.Create("HostResources", inHostResources.AsCimInstance(), inHostResources == null ? CimFlags.NullValue : CimFlags.None));
            parameters.Add(CimMethodParameter.Create("ResourceType", inResourceType, inResourceType == null ? CimFlags.NullValue : CimFlags.None));
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob, CIMResourcePool outPool) CreateChildResourcePool(System.String inElementName, IEnumerable<CIMResourcePool> inParentPool, System.String[] inSettings)
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("ElementName", inElementName, inElementName == null ? CimFlags.NullValue : CimFlags.None));
            parameters.Add(CimMethodParameter.Create("ParentPool", inParentPool.AsCimInstance(), inParentPool == null ? CimFlags.NullValue : CimFlags.None));
            parameters.Add(CimMethodParameter.Create("Settings", inSettings, inSettings == null ? CimFlags.NullValue : CimFlags.None));
