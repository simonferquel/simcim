...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmHostedEthernetSwitchExtensionAssociation
    {
        ...
        public IEnumerable<MsvmEthernetSwitchExtension> Dependent(MsvmVirtualEthernetSwitch inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MsvmVirtualEthernetSwitch> Antecedent(MsvmEthernetSwitchExtension inDependent)
        {
            var scope = _scope;
