...
{
    public struct MsvmHostedDependencyAssociation
    {
        private static AssociationResolver _resolver = new AssociationResolver("Msvm_HostedDependency", "CIM_ManagedElement", "CIM_ManagedElement", "Antecedent", "Dependent");
        private IInfrastructureObjectScope _scope;
        public MsvmHostedDependencyAssociation(IInfrastructureObjectScope scope)
        {
            _scope = scope;
        }

        public IEnumerable<CIMManagedElement> Dependent(CIMManagedElement inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMManagedElement> Antecedent(CIMManagedElement inDependent)
        {
            var scope = _scope;
