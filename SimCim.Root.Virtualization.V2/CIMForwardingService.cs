...
namespace SimCim.Root.Virtualization.V2
{
    public abstract class CIMForwardingService : CIMNetworkService
    {
        ...
        public CIMProtocolEndpoint ResolveCIMForwardsAmongAntecedent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/virtualization/v2", InnerCimInstance, "CIM_ForwardsAmong", "CIM_ProtocolEndpoint", "Dependent", "Antecedent");
