...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmHostedServiceAssociation
    {
        ...
        public IEnumerable<CIMService> Dependent(CIMSystem inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMSystem> Antecedent(CIMService inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
