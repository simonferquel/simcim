...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmBasedOnAssociation
    {
        ...
        public IEnumerable<CIMStorageExtent> Dependent(CIMStorageExtent inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMStorageExtent> Antecedent(CIMStorageExtent inDependent)
        {
            var scope = _scope;
