...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmParentEthernetSwitchExtensionAssociation
    {
        ...
        public IEnumerable<MsvmEthernetSwitchExtension> Dependent(MsvmEthernetSwitchExtension inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MsvmEthernetSwitchExtension> Antecedent(MsvmEthernetSwitchExtension inDependent)
        {
            var scope = _scope;
