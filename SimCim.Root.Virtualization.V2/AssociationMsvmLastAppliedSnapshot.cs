...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmLastAppliedSnapshotAssociation
    {
        ...
        public IEnumerable<CIMComputerSystem> Dependent(CIMVirtualSystemSettingData inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMVirtualSystemSettingData> Antecedent(CIMComputerSystem inDependent)
        {
            var scope = _scope;
