...
{
    public class CIMMostCurrentSnapshotInBranch : CIMDependency
    {
        public CIMMostCurrentSnapshotInBranch()
        {
        }

        public CIMMostCurrentSnapshotInBranch(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
