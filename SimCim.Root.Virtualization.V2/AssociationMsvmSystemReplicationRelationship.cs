...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmSystemReplicationRelationshipAssociation
    {
        ...
        public IEnumerable<MsvmReplicationRelationship> Dependent(MsvmComputerSystem inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MsvmComputerSystem> Antecedent(MsvmReplicationRelationship inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
