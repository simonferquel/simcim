...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmResourceAllocationFromPoolAssociation
    {
        ...
        public IEnumerable<CIMResourceAllocationSettingData> Dependent(CIMResourcePool inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMResourcePool> Antecedent(CIMResourceAllocationSettingData inDependent)
        {
            var scope = _scope;
