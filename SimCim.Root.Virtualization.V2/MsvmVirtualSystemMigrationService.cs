...
namespace SimCim.Root.Virtualization.V2
{
    public class MsvmVirtualSystemMigrationService : CIMVirtualSystemMigrationService
    {
        ...
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("ServiceSettingData", inServiceSettingData, inServiceSettingData == null ? CimFlags.NullValue : CimFlags.None));
        ...
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("NetworkSettings", inNetworkSettings.AsCimInstance(), inNetworkSettings == null ? CimFlags.NullValue : CimFlags.None));
        ...
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("CompatibilityInfo", inCompatibilityInfo, inCompatibilityInfo == null ? CimFlags.NullValue : CimFlags.None));
