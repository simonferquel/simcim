...
namespace SimCim.Root.Virtualization.V2
{
    public class MsvmVirtualSystemMigrationServiceSettingData : CIMSettingData
    {
        ...
        public IEnumerable<MsvmVirtualSystemMigrationNetworkSettingData> ResolveMsvmVirtualSystemMigrationServiceSettingDataComponentPartComponent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/virtualization/v2", InnerCimInstance, "Msvm_VirtualSystemMigrationServiceSettingDataComponent", "Msvm_VirtualSystemMigrationNetworkSettingData", "GroupComponent", "PartComponent");
            return instances.Select(i => (MsvmVirtualSystemMigrationNetworkSettingData)InfrastuctureObjectScope.Mapper.Create(i));
        }
    }
}