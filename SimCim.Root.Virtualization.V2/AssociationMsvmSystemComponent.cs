...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmSystemComponentAssociation
    {
        ...
        public IEnumerable<CIMManagedSystemElement> PartComponent(CIMSystem inGroupComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMSystem> GroupComponent(CIMManagedSystemElement inPartComponent, CimOperationOptions options = null)
        {
            var scope = _scope;
