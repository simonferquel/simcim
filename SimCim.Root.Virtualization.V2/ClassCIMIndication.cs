...
{
    public class CIMIndication : ExtrinsicEvent
    {
        public CIMIndication()
        {
        }

        public CIMIndication(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
