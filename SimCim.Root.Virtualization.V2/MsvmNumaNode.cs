...
namespace SimCim.Root.Virtualization.V2
{
    public class MsvmNumaNode : CIMEnabledLogicalElement
    {
        ...
        public CIMLogicalElement ResolveMsvmElementAllocatedFromNumaNodeDependent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/virtualization/v2", InnerCimInstance, "Msvm_ElementAllocatedFromNumaNode", "CIM_LogicalElement", "Antecedent", "Dependent");
