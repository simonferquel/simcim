...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmReferencePointOfVirtualSystemAssociation
    {
        ...
        public IEnumerable<MsvmVirtualSystemReferencePoint> Dependent(MsvmComputerSystem inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MsvmComputerSystem> Antecedent(MsvmVirtualSystemReferencePoint inDependent)
        {
            var scope = _scope;
