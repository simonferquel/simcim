...
namespace SimCim.Root.Virtualization.V2
{
    public class MsvmCollectionManagementService : CIMService
    {
        ...
        public (System.UInt32 retval, CIMCollectionOfMSEs outDefinedCollection, CIMConcreteJob outJob) DefineCollection(System.String inId, System.String inName, System.UInt16? inType)
        {
            ...
            parameters.Add(CimMethodParameter.Create("Id", inId, inId == null ? CimFlags.NullValue : CimFlags.None));
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob) RenameCollection(CIMCollectionOfMSEs inCollection, System.String inNewName)
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("Collection", inCollection.AsCimInstance(), inCollection == null ? CimFlags.NullValue : CimFlags.None));
            parameters.Add(CimMethodParameter.Create("NewName", inNewName, inNewName == null ? CimFlags.NullValue : CimFlags.None));
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob) AddMember(CIMCollectionOfMSEs inCollection, CIMManagedElement inMember)
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("Collection", inCollection.AsCimInstance(), inCollection == null ? CimFlags.NullValue : CimFlags.None));
            parameters.Add(CimMethodParameter.Create("Member", inMember.AsCimInstance(), inMember == null ? CimFlags.NullValue : CimFlags.None));
        ...
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("CollectionId", inCollectionId, inCollectionId == null ? CimFlags.NullValue : CimFlags.None));
            parameters.Add(CimMethodParameter.Create("Member", inMember.AsCimInstance(), inMember == null ? CimFlags.NullValue : CimFlags.None));
