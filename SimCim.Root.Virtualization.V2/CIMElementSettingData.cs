...
{
    public abstract class CIMElementSettingData : GenericInfrastructureObject
    {
        protected CIMElementSettingData()
        {
        }

        protected CIMElementSettingData(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
