...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmReplicaSystemDependencyAssociation
    {
        ...
        public IEnumerable<CIMComputerSystem> Dependent(CIMComputerSystem inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMComputerSystem> Antecedent(CIMComputerSystem inDependent)
        {
            var scope = _scope;
