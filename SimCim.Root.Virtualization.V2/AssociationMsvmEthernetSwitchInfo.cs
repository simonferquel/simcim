...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmEthernetSwitchInfoAssociation
    {
        ...
        public IEnumerable<MsvmEthernetSwitchData> Dependent(MsvmVirtualEthernetSwitch inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MsvmVirtualEthernetSwitch> Antecedent(MsvmEthernetSwitchData inDependent)
        {
            var scope = _scope;
