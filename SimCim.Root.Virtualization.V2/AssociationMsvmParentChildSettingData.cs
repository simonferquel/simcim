...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmParentChildSettingDataAssociation
    {
        ...
        public IEnumerable<MsvmVirtualSystemSettingData> Dependent(MsvmVirtualSystemSettingData inAntecedent, CimOperationOptions options = null)
        {
            var scope = _scope;
        ...
        public IEnumerable<MsvmVirtualSystemSettingData> Antecedent(MsvmVirtualSystemSettingData inDependent, CimOperationOptions options = null)
        {
            var scope = _scope;
