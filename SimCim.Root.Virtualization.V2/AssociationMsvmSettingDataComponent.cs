...
{
    public struct MsvmSettingDataComponentAssociation
    {
        private static AssociationResolver _resolver = new AssociationResolver("Msvm_SettingDataComponent", "CIM_ResourceAllocationSettingData", "Msvm_GuestNetworkAdapterConfiguration", "GroupComponent", "PartComponent");
        private IInfrastructureObjectScope _scope;
        public MsvmSettingDataComponentAssociation(IInfrastructureObjectScope scope)
        {
            _scope = scope;
        }

        public IEnumerable<MsvmGuestNetworkAdapterConfiguration> PartComponent(CIMResourceAllocationSettingData inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMResourceAllocationSettingData> GroupComponent(MsvmGuestNetworkAdapterConfiguration inPartComponent)
        {
            var scope = _scope;
