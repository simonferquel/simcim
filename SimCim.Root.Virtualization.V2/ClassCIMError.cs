...
{
    public abstract class CIMError : GenericInfrastructureObject
    {
        protected CIMError()
        {
        }

        protected CIMError(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
