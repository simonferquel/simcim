...
namespace SimCim.Root.Virtualization.V2
{
    public class MsvmAssignableDeviceService : CIMService
    {
        ...
        public (System.UInt32 retval, System.String outDismountedDeviceInstancePath, CIMConcreteJob outJob) DismountAssignableDevice(System.String inDismountSettingData)
        {
            ...
            parameters.Add(CimMethodParameter.Create("DismountSettingData", inDismountSettingData, inDismountSettingData == null ? CimFlags.NullValue : CimFlags.None));
        ...
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("DeviceInstancePath", inDeviceInstancePath, inDeviceInstancePath == null ? CimFlags.NullValue : CimFlags.None));
            parameters.Add(CimMethodParameter.Create("DeviceLocationPath", inDeviceLocationPath, inDeviceLocationPath == null ? CimFlags.NullValue : CimFlags.None));
