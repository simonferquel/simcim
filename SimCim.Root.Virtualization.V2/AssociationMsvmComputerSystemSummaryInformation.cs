...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmComputerSystemSummaryInformationAssociation
    {
        ...
        public IEnumerable<MsvmSummaryInformationBase> Dependent(CIMComputerSystem inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMComputerSystem> Antecedent(MsvmSummaryInformationBase inDependent)
        {
            var scope = _scope;
