...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmMostCurrentSnapshotInBranchAssociation
    {
        ...
        public IEnumerable<MsvmVirtualSystemSettingData> Dependent(CIMComputerSystem inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMComputerSystem> Antecedent(MsvmVirtualSystemSettingData inDependent)
        {
            var scope = _scope;
