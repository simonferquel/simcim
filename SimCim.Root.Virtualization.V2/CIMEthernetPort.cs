...
namespace SimCim.Root.Virtualization.V2
{
    public abstract class CIMEthernetPort : CIMNetworkPort
    {
        ...
        public MsvmLANEndpoint ResolveMsvmEthernetDeviceSAPImplementationDependent()
        {
            var instances = InfrastuctureObjectScope.CimSession.EnumerateAssociatedInstances("root/virtualization/v2", InnerCimInstance, "Msvm_EthernetDeviceSAPImplementation", "Msvm_LANEndpoint", "Antecedent", "Dependent");
