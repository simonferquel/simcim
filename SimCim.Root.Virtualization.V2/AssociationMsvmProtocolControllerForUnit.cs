...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmProtocolControllerForUnitAssociation
    {
        ...
        public IEnumerable<CIMLogicalDevice> Dependent(CIMProtocolController inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMProtocolController> Antecedent(CIMLogicalDevice inDependent)
        {
            var scope = _scope;
