...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmSystemBIOSAssociation
    {
        ...
        public IEnumerable<MsvmBIOSElement> PartComponent(CIMComputerSystem inGroupComponent)
        {
            var scope = _scope;
        ...
        public IEnumerable<CIMComputerSystem> GroupComponent(MsvmBIOSElement inPartComponent)
        {
            var scope = _scope;
