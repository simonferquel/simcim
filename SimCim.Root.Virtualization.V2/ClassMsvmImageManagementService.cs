...
namespace SimCim.Root.Virtualization.V2
{
    public class MsvmImageManagementService : CIMService
    {
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob, System.String outSettingData) GetVirtualHardDiskSettingData(System.String inPath)
        {
            ...
            return ((System.UInt32)result.ReturnValue.Value, (CIMConcreteJob)InfrastuctureObjectScope.Mapper.Create(InfrastuctureObjectScope, (CimInstance)result.OutParameters["Job"].Value), (System.String)result.OutParameters["SettingData"].Value);
        }
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob, System.String outState) GetVirtualHardDiskState(System.String inPath)
        {
            ...
            return ((System.UInt32)result.ReturnValue.Value, (CIMConcreteJob)InfrastuctureObjectScope.Mapper.Create(InfrastuctureObjectScope, (CimInstance)result.OutParameters["Job"].Value), (System.String)result.OutParameters["State"].Value);
        }
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob, System.String[] outSnapshotInformation) GetVHDSnapshotInformation(System.UInt32[] inAdditionalInformation, System.String[] inSnapshotIds, System.String inVHDSetPath)
        {
            ...
            return ((System.UInt32)result.ReturnValue.Value, (CIMConcreteJob)InfrastuctureObjectScope.Mapper.Create(InfrastuctureObjectScope, (CimInstance)result.OutParameters["Job"].Value), (System.String[])result.OutParameters["SnapshotInformation"].Value);
        }
