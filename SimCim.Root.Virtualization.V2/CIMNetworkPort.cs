...
{
    public abstract class CIMNetworkPort : CIMLogicalPort
    {
        protected CIMNetworkPort()
        {
        }

        protected CIMNetworkPort(IInfrastructureObjectScope scope, CimInstance instance): base(scope, instance)
        {
        }
