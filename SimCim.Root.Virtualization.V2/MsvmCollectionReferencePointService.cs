...
namespace SimCim.Root.Virtualization.V2
{
    public class MsvmCollectionReferencePointService : CIMService
    {
        ...
        {
            var parameters = new CimMethodParametersCollection();
            parameters.Add(CimMethodParameter.Create("AffectedReferencePointCollection", inAffectedReferencePointCollection.AsCimInstance(), inAffectedReferencePointCollection == null ? CimFlags.NullValue : CimFlags.None));
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob) ExportReferencePoint(System.String inExportDirectory, System.String inExportSettingData, CIMCollection inReferencePointCollection)
        {
            ...
            parameters.Add(CimMethodParameter.Create("ReferencePointCollection", inReferencePointCollection.AsCimInstance(), inReferencePointCollection == null ? CimFlags.NullValue : CimFlags.None));
