...
namespace SimCim.Root.Virtualization.V2
{
    public class MsvmAssignableDeviceService : CIMService
    {
        ...
        public (System.UInt32 retval, System.String outDismountedDeviceInstancePath, CIMConcreteJob outJob) DismountAssignableDevice(System.String inDismountSettingData)
        {
            ...
            return ((System.UInt32)result.ReturnValue.Value, (System.String)result.OutParameters["DismountedDeviceInstancePath"].Value, (CIMConcreteJob)InfrastuctureObjectScope.Mapper.Create(InfrastuctureObjectScope, (CimInstance)result.OutParameters["Job"].Value));
        }
        ...
        public (System.UInt32 retval, CIMConcreteJob outJob, System.String outMountedDeviceInstancePath) MountAssignableDevice(System.String inDeviceInstancePath, System.String inDeviceLocationPath)
        {
            ...
            return ((System.UInt32)result.ReturnValue.Value, (CIMConcreteJob)InfrastuctureObjectScope.Mapper.Create(InfrastuctureObjectScope, (CimInstance)result.OutParameters["Job"].Value), (System.String)result.OutParameters["MountedDeviceInstancePath"].Value);
        }
    }
}