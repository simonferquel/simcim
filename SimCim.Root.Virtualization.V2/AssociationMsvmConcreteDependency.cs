...
namespace SimCim.Root.Virtualization.V2
{
    public struct MsvmConcreteDependencyAssociation
    {
        ...
        public IEnumerable<MsvmEthernetSwitchExtension> Dependent(MsvmInstalledEthernetSwitchExtension inAntecedent)
        {
            var scope = _scope;
        ...
        public IEnumerable<MsvmInstalledEthernetSwitchExtension> Antecedent(MsvmEthernetSwitchExtension inDependent)
        {
            var scope = _scope;
